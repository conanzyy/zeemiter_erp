var queryConditions = {
	...
	THISPAGE = {
		...
		loadGrid: function() {
			function a(a, b, c) {
				if(c.from == "shop"){
					var d = '<div class="operating" data-id="' + c.id + '"><span class="min-btn btn-success ui-icon-pencil" title="查看"><span class="fa fa-edit"></span>查看</span> <span class="min-btn btn-warning ui-icon-trash" title="删除"><span class="fa fa-trash"></span>删除</span></span></div>';
				}else {
