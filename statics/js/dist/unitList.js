	...
	var a = Public.setGrid(ajustH, ajustW),
		b = [{
			...
			formatter: function(a,b,c){
				if(c.isSelf){
					return '<span class="min-btn btn-default ui-icon-trash btn-allowed" title="不可编辑"><span class="fa fa-close"></span>不可编辑</span>';
				}else{
					var html_con = '<div class="operating" data-id="' + c.id + '"><span class="min-btn btn-success ui-icon-pencil" title="修改"><span class="fa fa-edit"></span>修改</span> <span class="min-btn btn-warning ui-icon-trash " title="删除"><span class="fa fa-trash"></span>删除</span></div>';
					return html_con;
				}
			}
		}, {
