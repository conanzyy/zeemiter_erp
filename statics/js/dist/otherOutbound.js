var curRow, curCol, curArrears, loading, urlParam = Public.urlParam(),
	...
	THISPAGE = {
		...
		getArea:function(a){
			...
			var params = {invId:goodsInfo.id,locationId:locationId,num:rowData.qty,transType:"150806",id:originalData.id};
			Public.ajaxPost("../scm/invOi/area", params, function (res) {
		...
		loadGrid: function(a) {
			...
			$("#grid").jqGrid({
				...
				afterSaveCell: function(a, b, c,d,e,f) {
					switch (b) {
					case "goods":
						break;
						case "qty":
							var d = parseFloat(c),
								g = parseFloat($("#grid").jqGrid("getCell", a, e + 1));
