...
function operFmatter(val, opt, row){
	if(row.isSelf == 1) return '<div class="operating" data-id="' + row.id + '"><span class="min-btn btn-success ui-icon-pencil" title="修改"><span class="fa fa-edit"></span>修改</span></div>';
