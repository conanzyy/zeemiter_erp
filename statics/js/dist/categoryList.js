...
function operFmatter(val, opt, row){
	if(row.isSelf == 1) return '<span class="min-btn btn-default ui-icon-trash btn-allowed" title="不可编辑"><span class="fa fa-close"></span>不可编辑</span>';
...
var conditions = {
	...
	handle = {
		operate: function(a, b) {
			...
			var d = ['<form id="manage-form" action="">', '<ul class="mod-form-rows manage-wrap" id="manager">', '<li class="row-item" style="position:relative; display:none;">', '<div class="label-wrap"><label for="ParentCategory">上级分类:<em style="color:red">*</em></label></div>', '<div class="ctn-wrap" style="position:relative;"><input type="text" value="" class="ui-input" name="ParentCategory" id="ParentCategory" readonly></div>', '<div class="dn hideFeild"></div>', "</li>", '<li class="row-item">', '<div class="label-wrap"><label for="category">类别: <em style="color:red">*</em></label></div>', '<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="category" id="category"></div>', "</li>", "</ul>", "</form>"],
				e = 90;
