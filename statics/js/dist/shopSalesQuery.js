	...
	addEvent: function() {
		...
		if ($(".grid-wrap").on("click", ".ui-icon-pencil", function(a) {
			...
			var b = $(this).parent().data("id"),
				...
				e = ($("#grid").jqGrid("getDataIDs"), "手工订单"),
				f = "shopSalesQuery-shopSales";
			...
			parent.tab.addTabItem({
				tabid: f,
				text: e,
				url: "../scm/invSa?action=salesEdit&id=" + b + "&flag=list" + d + "&transType=" + queryConditions.transType
			})
		...
		$("#search").click(function() {
			...
			if (a.preventDefault(), Business.verifyRight("SA_ADD")) {
				...
				parent.tab.addTabItem({
					tabid: c,
					text: b,
					url: "../scm/invSa?action=initShopSales&transType=" + queryConditions.transType
				})
			}
