		...
		var a = Public.setGrid(f, g),
			...
			l = [{
				...
				formatter: function(a, b, c) {
					var d = "";							
					if(c.isSelf == 1){
						var d = '<div class="operating" data-id="' + c.id + '"> <span class=" min-btn btn-info ui-icon-pic" title="商品图片"><span class = "fa fa-image"></span>图片</span></div>';
					}else{
						var d = '<div class="operating" data-id="' + c.id + '"><span class="min-btn btn-success ui-icon-pencil" title="修改"><span class="fa fa-edit"></span>修改</span> <span class="min-btn btn-warning ui-icon-trash" title="删除"><span class="fa fa-trash"></span>删除</span></span> <span class=" min-btn btn-info ui-icon-pic" title="商品图片"><span class = "fa fa-image"></span>图片</span></div>';
					}
					return d
				},
				title: !1
	...
	function c() {
		$_matchCon = $("#matchCon"), $_matchCon.placeholder(), $("#search").on("click", function(a) {
			...
			a.preventDefault(), Business.verifyRight("BaseData_IMPORT") && parent.$.dialog({
				...
				height: 300,
				title: "批量导入",
				content: "url:"+CONFIG.SITE_URL+"/settings/import",
				lock: !0
			})
