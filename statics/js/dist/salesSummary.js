define(["jquery", "print"], function(a) {
	...
	function e(a) {
		...
		c > d && (c = d), b < h.width() && (c += 17), i("#grid-wrap").height(function() {
			return document.body.clientHeight - this.offsetTop - 36 - 15
		}), h.jqGrid("setGridHeight", c), h.jqGrid("setGridWidth", b, !1)
	}
	function f() {
		return i(window).width() - i("#grid-wrap").offset().left - 36 - 15
	}
	function g() {
		return i(window).height() - i("#grid").offset().top - 36 - 15 - 17
	}
	function h(a) {
