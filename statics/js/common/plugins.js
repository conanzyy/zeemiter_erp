...
function(a) {
    ...
    a.Combo.prototype = {
        ...
        _init: function() {
            var a = this.opts;
            "select" == this.obj[0].tagName.toLowerCase() && (this.originSelect = this.obj, this.dataOpt = this._getDataFromSelect()),
            this._createCombo(),
        ...
        loadData: function(a, b, c) {
            ...
            this.mode && ("local" == this.mode ? (this._formatData(), this._populateList(this.formattedData), this._setDefaultSelected(b, c)) : "remote" == this.mode && this._loadAjaxData(b, c))
        },
        activate: function() {
        ...
        _bindEvent: function() {
            ...
            c.editable ? b.input.on("click",
            function() {}) : b.input.on("click",
            function() {
                b._onTriggerClick()
            }),
            b.trigger && b.trigger.on("click",
            function() {
                b._onTriggerClick()
            }),
            a(document).on("click",
        ...
        _createCombo: function() {
            ...
            "input" == this.obj[0].tagName.toLowerCase() ? this.input = this.obj: (c = this.obj.find("." + e.inputCls), this.input = c.length > 0 ? c: a('<input type="text" class="' + e.inputCls + '"/>')),
            this.input.attr({
                autocomplete: "off",
                readOnly: !e.editable
            }).css({
            ...
            b.length > 0 ? this.wrap = b.append(this.input, this.trigger) : this.trigger && (this.wrap = a('<span class="' + e.wrapCls + '"></span>').append(this.input, this.trigger), this.originSelect && this.obj[0] == this.originSelect[0] || this.obj[0] == this.input[0] ? this.obj.next().length > 0 ? this.wrap.insertBefore(this.obj.next()) : this.wrap.appendTo(this.obj.parent()) : this.wrap.appendTo(this.obj)),
            ...
            e.listRenderToBody ? (a.Combo.allListWrap || (a.Combo.allListWrap = a('<div id="COMBO_WRAP"/>').appendTo("body")), this.listWrap.appendTo(a.Combo.allListWrap)) : this.wrap.after(this.listWrap)
        },
        ...
        _setComboLayout: function(a) {
            if (a) {
                ...
                d = parseInt(b.minWidth); ! isNaN(c) && a > c && (a = c),
                !isNaN(d) && d > a && (a = d);
                var e;
                a -= this.wrap.outerWidth() - this.wrap.width(),
                this.wrap.width(a),
                this.wrap[0] != this.input[0] && (e = a - (this.trigger ? this.trigger.outerWidth() : 0) - (this.input.outerWidth() - this.input.width()), this.input.width(e))
            }
        },
        ...
        _getRenderMode: function() {
            ...
            a.isArray(c) ? (this.rawData = c, b = "local") : "string" == typeof c && (this.url = c, b = "remote"),
            b
        },
        _loadAjaxData: function(b, c, d) {
            ...
            e.xhr = a.ajax({
                ...
                success: function(f) {
                    ...
                    f && (e.rawData = f, e._formatData(), e._populateList(e.formattedData), "" === b ? (e.lastQuery = d, e.filterData = e.formattedData, e.expand()) : e._setDefaultSelected(b, c), e.xhr = null, e.mode = e._getRenderMode())
                },
                error: function() {
                    h.remove(),
        ...
        selectByText: function(a, b) {
            if (this.formattedData) {
                for (var c = this.formattedData,
                d = -1,
                e = 0,
                f = c.length; f > e; e++) if (c[e].text === a) {
                    d = e;
                    break
                }
        ...
        selectByValue: function(a, b) {
            if (this.formattedData) {
                ...
                d = -1,
                e = 0,
                f = c.length; f > e; e++) if (c[e].value === a) {
                    d = e;
                    break
                }
                this._setSelected(d, b)
        ...
        selectByKey: function(a, b, c) {
            if (this.rawData) {
                ...
                if (e.addOptions || e.emptyOptions) {
                    ...
                    for (var h = 0,
                    i = f.length; i > h; h++) if (f[h].value === b) {
                        g = h;
                        break
                    }
                } else for (var h = 0,
                i = f.length; i > h; h++) if (f[h][a] === b) {
                    g = h;
                    break
                }
        ...
        _getDataFromSelect: function() {
            var b = this.opts,
            c = [];
            return a.each(this.originSelect.find("option"),
            function() {
                var d = a(this),
                e = {};
                e[b.text] = d.text(),
                e[b.value] = d.attr("value"),
                c.push(e)
            }),
            c
        },
        ...
        _filter: function(b) {
            ...
            if (this.opts.cache || ("local" == this.mode && a.isFunction(this.dataOpt) && (this.rawData = this.dataOpt()), this._formatData()), a.isArray(this.formattedData)) {
                ...
                for (var g = {},
                h = [], i = 0, j = this.filterData.length; j > i; i++) {
                ...
                h = [],
                g = {},
                100 === e.formattedLen && e.filterData.length < d.maxFilter ? e.addQuery === !0 && this.incrementalSearch(f, c) : (this.lastQuery = b, this.list.empty(), this._populateList(this.filterData), this.expand())
            }
        },
        ...
        expand: function() {
            ...
            if (0 != c.length) {
                ...
                0 == d.length && (d = c.eq(0), b.autoSelectFirst && d.addClass(b.hoverCls)),
        ...
        _scrollToItem: function(a) {
            if (a && 0 != a.length) {
                ...
                e = c + a.outerHeight(); (b > c || e > d) && this.list.scrollTop(c)
            }
        },
        ...
        _setItemFocus: function(a) {
            ...
            if (0 != e.length) {
                ...
                0 == f.length ? b = 0 : (b = e.index(f), b = "next" == a ? b == e.length - 1 ? 0 : b + 1 : 0 == b ? e.length - 1 : b - 1),
                c = e.eq(b),
...
function(a) {
    a.extend(a.fn, {
        validate: function(b) {
            ...
            return c ? c: ("undefined" != typeof Worker && this.attr("novalidate", "novalidate"), c = new a.validator(b, this[0]), a.data(this[0], "validator", c), c.settings.onsubmit && (this.validateDelegate(":submit", "click",
            function(b) {
        ...
        return a(this).each(function() {
            ...
            case "hover":
                a(this).hover(function() {
                    ...
                    g(f, a(this)),
                    c ? (e && clearTimeout(e), e = setTimeout(function() {
                        b.targetGet.call(b)
                    },
                    c)) : b.targetGet()
                },
            ...
            case "click":
                a(this).click(function(c) {
                    b.display && b.trigger && c.target === b.trigger.get(0) ? (b.flagDisplay = !1, b.displayDetect()) : (g(f, a(this)), b.targetGet(), a(document).data("mouseupBind") || a(document).bind("mouseup",
                    function(c) {
                        var d = !1;
                        if (b.trigger) {
                            var e = b.target.attr("id");
                            e || (e = "R_" + Math.random(), b.target.attr("id", e)),
    ...
    var b = {
        targetGet: function() {
            ...
            case "ajax":
                ...
                g.onerror = function() {/(\.jpg|\.png|\.gif|\.bmp|\.jpeg)$/i.test(f) ? (b.target = a('<div class="float_ajax_error">图片加载失败。</div>'), b.targetShow()) : a.ajax({
                        url: f,
                        success: function(c) {
            ...
            case "list":
                ...
                a.isArray(d) && (h = d.length) ? a.each(d,
                function(a, b) {
                    var c, d, e = "",
                    f = "";
            ...
            case "remind":
                var j = d || c;
                this.targetProtect = !1,
                "string" == typeof j && (b.target = a("<span>" + j + "</span>"), b.targetShow());
                break;
            default:
                var k = d || c,
                e = typeof k;
        ...
        container: function() {
            ...
            return this.s.sharpAngle = "ajax" === d || "remind" === d ? !0 : !1,
            this.s.reverseSharp && (this.s.sharpAngle = !this.s.sharpAngle),
            "common" !== d && (null === c && (c = "plugin"), "plugin" === c && (a("#floatBox_" + d).size() || a('<div id="floatBox_' + d + '" class="float_' + d + '_box"></div>').appendTo(a("body")).hide(), c = a("#floatBox_" + d)), c && "string" != typeof c && c.size() && (this.targetProtect && b.target.show().css("position", "static"), b.target = c.empty().append(b.target))),
            this
        },
        setWidth: function() {
            var a = this.s.width;
        ...
        position: function() {
            ...
            s = this.cacheData;
            n || (n = this.target.outerHeight(), this.s.hoverFollow && this.target.data("height", n)),
            o || (o = this.target.outerWidth(), this.s.hoverFollow && this.target.data("width", o)),
        ...
        displayDetect: function() {
            return ! this.flagDisplay && this.display && (this.targetHide(), this.timerHold = null),
            this
        },
        targetShow: function() {
...
function(a, b) {
    ...
    u = function(a, c, d) {
        var e, f;
        for (e in c) f = a[e] !== b,
        f && "object" == typeof c[e] && c[e].nodeName === b ? o(c[e]) ? d && (a[e] = new Date(c[e].getTime())) : n(c[e]) ? d && (a[e] = c[e].slice(0)) : a[e] = u({},
        c[e], d) : (d || !f) && (a[e] = c[e]);
        return a
    },
    v = {
    ...
    D = function(b) {
        ...
        h._onMouseDown = function(b) {
            if (h._v) {
                ...
                if (c) {
                    if (!k(c, "is-disabled")) {
                        if (k(c, "pika-button") && !k(c, "is-empty")) return h.setDate(new Date(h._y, h._m, parseInt(c.innerHTML, 10))),
                    ...
                    if (h._c = !0, !k(c, "pika-select")) {
                        if (!b.preventDefault) return b.returnValue = !1,
                        b.cancelBubble = !0,
                        !1;
                        b.preventDefault(),
                        b.stopPropagation()
        ...
        h._onClick = function(b) {
            ...
            var c = b.target || b.srcElement,
            e = c;
            if (c) { ! d && k(c, "pika-select") && (c.onchange || (c.setAttribute("onchange", "return;"), g(c, "change", h._onChange)));
                do
        ...
        i.field && (i.bound ? e.body.appendChild(h.el) : i.field.parentNode.insertBefore(h.el, i.field.nextSibling), g(i.field, "change", h._onInputChange), i.defaultDate || (i.defaultDate = c && i.field.value ? moment(i.field.value, i.format).toDate() : p(i.field.value), i.setDefaultDate = !0));
        var j = i.defaultDate;
        o(j) ? i.setDefaultDate ? h.setDate(j, !0) : h.gotoDate(j) : h.gotoDate(new Date),
        i.bound ? (this.hide(), h.el.className += " is-bound", g(i.trigger, "click", h._onInputClick), g(i.trigger, "focus", h._onInputFocus), g(i.trigger, "blur", h._onInputBlur)) : this.show()
    };
    D.prototype = {
        config: function(a) {
            this._o || (this._o = u({},
            ...
            } else c.yearRange = Math.abs(parseInt(c.yearRange, 10)) || v.yearRange,
        ...
        setDate: function(a, b) {
            ...
            if ("string" == typeof a && (a = p(a)), o(a)) {
                ...
                this._o.field && (this._o.field.value = this.toString(), i(this._o.field, "change", {
                    firedBy: this
                })),
        ...
        nextMonth: function() {++this._m > 11 && (this._m = 0, this._y++),
            this.draw()
        },
        prevMonth: function() {--this._m < 0 && (this._m = 11, this._y--),
            this.draw()
        },
        gotoYear: function(a) {
        ...
        adjustPosition: function() {
            ...
            if (l(this.el, "is-hidden"), "function" == typeof f.getBoundingClientRect) d = f.getBoundingClientRect(),
            b = d.left + a.pageXOffset,
            c = d.bottom + a.pageYOffset;
            else for (b = g.offsetLeft, c = g.offsetTop + g.offsetHeight; g = g.offsetParent;) b += g.offsetLeft,
            c += g.offsetTop;
            m(this.el, "is-hidden"),
        ...
        render: function(a, b) {
            ...
            h = [];
            s(d),
            c.firstDay > 0 && (f -= c.firstDay, 0 > f && (f += 7));
            for (var i = e + f,
            j = i; j > 7;) j -= 7;
            i += 7 - j;
            for (var k = 0,
        ...
        destroy: function() {
            ...
            this._o.field && (h(this._o.field, "change", this._onInputChange), this._o.bound && (h(this._o.trigger, "click", this._onInputClick), h(this._o.trigger, "focus", this._onInputFocus), h(this._o.trigger, "blur", this._onInputBlur))),
...
function($) {
    ...
    _initNode = function(a, b, c, d, e, f) {
        if (c) {
            var g = data.getRoot(a),
            h = a.data.key.children;
            c.level = b,
            c.tId = a.treeId + "_" + ++g.zId,
            c.parentTId = d ? d.tId: null,
            c.open = "string" == typeof c.open ? tools.eqs(c.open, "true") : !!c.open,
            c[h] && c[h].length > 0 ? (c.isParent = !0, c.zAsync = !0) : (c.isParent = "string" == typeof c.isParent ? tools.eqs(c.isParent, "true") : !!c.isParent, c.open = c.isParent && !a.async.enable ? c.open: !1, c.zAsync = !c.isParent),
            c.isFirstNode = e,
            c.isLastNode = f,
    ...
    data = {
        ...
        addNodesData: function(a, b, c) {
            ...
            b[d] || (b[d] = []),
            b[d].length > 0 && (b[d][b[d].length - 1].isLastNode = !1, view.setNodeLineIcos(a, b[d][b[d].length - 1])),
            b.isParent = !0,
            b[d] = b[d].concat(c)
        },
        ...
        getAfterA: function() {
            for (var a = 0,
            b = _init.afterA.length; b > a; a++) _init.afterA[a].apply(this, arguments)
        },
        getBeforeA: function() {
            for (var a = 0,
            b = _init.beforeA.length; b > a; a++) _init.beforeA[a].apply(this, arguments)
        },
        getInnerAfterA: function() {
            for (var a = 0,
            b = _init.innerAfterA.length; b > a; a++) _init.innerAfterA[a].apply(this, arguments)
        },
        getInnerBeforeA: function() {
            for (var a = 0,
            b = _init.innerBeforeA.length; b > a; a++) _init.innerBeforeA[a].apply(this, arguments)
        },
        getCache: function(a) {
        ...
        getNextNode: function(a, b) {
            if (!b) return null;
            for (var c = a.data.key.children,
            d = b.parentTId ? b.getParentNode() : data.getRoot(a), e = 0, f = d[c].length - 1; f >= e; e++) if (d[c][e] === b) return e == f ? null: d[c][e + 1];
            return null
        },
        getNodeByParam: function(a, b, c, d) {
            if (!b || !c) return null;
            for (var e = a.data.key.children,
            f = 0,
            g = b.length; g > f; f++) {
        ...
        getNodesByParam: function(a, b, c, d) {
            if (!b || !c) return [];
            for (var e = a.data.key.children,
            f = [], g = 0, h = b.length; h > g; g++) b[g][c] == d && f.push(b[g]),
        ...
        getNodesByParamFuzzy: function(a, b, c, d) {
            ...
            d = d.toLowerCase();
            for (var g = 0,
            h = b.length; h > g; g++)"string" == typeof b[g][c] && b[g][c].toLowerCase().indexOf(d) > -1 && f.push(b[g]),
            f = f.concat(data.getNodesByParamFuzzy(a, b[g][e], c, d));
            return f
        },
        getNodesByFilter: function(a, b, c, d, e) {
            if (!b) return d ? null: [];
            for (var f = a.data.key.children,
            g = d ? null: [], h = 0, i = b.length; i > h; h++) {
        ...
        getPreNode: function(a, b) {
            if (!b) return null;
            for (var c = a.data.key.children,
            d = b.parentTId ? b.getParentNode() : data.getRoot(a), e = 0, f = d[c].length; f > e; e++) if (d[c][e] === b) return 0 == e ? null: d[c][e - 1];
            return null
        },
        getRoot: function(a) {
        ...
        initCache: function() {
            for (var a = 0,
            b = _init.caches.length; b > a; a++) _init.caches[a].apply(this, arguments)
        },
        initNode: function() {
            for (var a = 0,
            b = _init.nodes.length; b > a; a++) _init.nodes[a].apply(this, arguments)
        },
        initRoot: function() {
            for (var a = 0,
            b = _init.roots.length; b > a; a++) _init.roots[a].apply(this, arguments)
        },
        ...
        removeNodeCache: function(a, b) {
            ...
            if (b[c]) for (var d = 0,
            e = b[c].length; e > d; d++) arguments.callee(a, b[c][d]);
        ...
        setZTreeTools: function() {
            for (var a = 0,
            b = _init.zTreeTools.length; b > a; a++) _init.zTreeTools[a].apply(this, arguments)
        },
        transformToArrayFormat: function(a, b) {
            if (!b) return [];
            var c = a.data.key.children,
            d = [];
            if (tools.isArray(b)) for (var e = 0,
            f = b.length; f > e; e++) d.push(b[e]),
    ...
    event = {
        bindEvent: function() {
            for (var a = 0,
            b = _init.bind.length; b > a; a++) _init.bind[a].apply(this, arguments)
        },
        unbindEvent: function() {
            for (var a = 0,
            b = _init.unbind.length; b > a; a++) _init.unbind[a].apply(this, arguments)
        },
        bindTree: function(a) {
            var b = {
                treeId: a.treeId
        ...
        proxy: function(a) {
            ...
            for (var c = event.doProxy(a), d = !0, e = !1, f = 0, g = c.length; g > f; f++) {
                var h = c[f];
                h.nodeEventCallback && (e = !0, d = h.nodeEventCallback.apply(h, [a, h.node]) && d),
                h.treeEventCallback && (e = !0, d = h.treeEventCallback.apply(h, [a, h.node]) && d)
            }
            return d
        }
    },
    ...
    tools = {
        ...
        getMDom: function(a, b, c) {
            ...
            for (; b && b.id !== a.treeId;) {
                for (var d = 0,
                e = c.length; b.tagName && e > d; d++) if (tools.eqs(b.tagName, c[d].tagName) && null !== b.getAttribute(c[d].attrName)) return b;
                b = b.parentNode
            }
            return null
        },
    ...
    view = {
        addNodes: function(a, b, c, d) {
            if (!a.data.keep.leaf || !b || b.isParent) if (tools.isArray(c) || (c = [c]), a.data.simpleData.enable && (c = data.transformTozTreeFormat(a, c)), b) {
                ...
                g = $$(b, consts.id.UL, a);
                b.open || (view.replaceSwitchClass(b, e, consts.folder.CLOSE), view.replaceIcoClass(b, f, consts.folder.CLOSE), b.open = !1, g.css({
                    display: "none"
                })),
                data.addNodesData(a, b, c),
                view.createNodes(a, b.level + 1, c, b),
                d || view.expandCollapseParentNode(a, b, !0)
            } else data.addNodesData(a, data.getRoot(a), c),
        ...
        asyncNode: function(setting, node, isSilent, callback) {
            var i, l;
            if (node && !node.isParent) return tools.apply(callback),
            !1;
            if (node && node.isAjaxing) return ! 1;
            if (0 == tools.apply(setting.callback.beforeAsync, [setting.treeId, node], !0)) return tools.apply(callback),
            !1;
            if (node) {
                node.isAjaxing = !0;
            ...
            if (tools.isArray(setting.async.otherParam)) for (i = 0, l = setting.async.otherParam.length; l > i; i += 2) tmpParam[setting.async.otherParam[i]] = setting.async.otherParam[i + 1];
        ...
        expandCollapseNode: function(a, b, c, d, e) {
            ...
            g = a.data.key.children;
            if (!b) return void tools.apply(e, []);
            ...
            if (!b.open && b.isParent && (!$$(b, consts.id.UL, a).get(0) || b[g] && b[g].length > 0 && !$$(b[g][0], a).get(0)) && (view.appendParentULDom(a, b), view.createNodeCallback(a)), b.open == c) return void tools.apply(e, []);
        ...
        expandCollapseParentNode: function(a, b, c, d, e) {
            if (b) {
                if (!b.parentTId) return void view.expandCollapseNode(a, b, c, d, e);
        ...
        expandCollapseSonNode: function(a, b, c, d, e) {
            ...
            if (data.getRoot(a).expandTriggerFlag = !1, h) for (var k = 0,
            l = h.length; l > k; k++) h[k] && view.expandCollapseSonNode(a, h[k], c, i);
        ...
        makeNodeIcoClass: function(a, b) {
            var c = ["ico"];
            return b.isAjaxing || (c[0] = (b.iconSkin ? b.iconSkin + "_": "") + c[0], c.push(b.isParent ? b.open ? consts.folder.OPEN: consts.folder.CLOSE: consts.folder.DOCU)),
        ...
        makeNodeLineClass: function(a, b) {
            var c = [];
            return c.push(a.view.showLine ? 0 == b.level && b.isFirstNode && b.isLastNode ? consts.line.ROOT: 0 == b.level && b.isFirstNode ? consts.line.ROOTS: b.isLastNode ? consts.line.BOTTOM: consts.line.CENTER: consts.line.NOLINE),
            c.push(b.isParent ? b.open ? consts.folder.OPEN: consts.folder.CLOSE: consts.folder.DOCU),
        ...
        removeChildNodes: function(a, b) {
            if (b) {
                ...
                if (d) {
                    for (var e = 0,
                    f = d.length; f > e; e++) data.removeNodeCache(a, d[e]);
                    if (data.removeSelectedNode(a), delete b[c], a.data.keep.parent) $$(b, consts.id.UL, a).empty();
                    else {
                        b.isParent = !1,
                        b.open = !1;
        ...
        removeNode: function(a, b) {
            ...
            data.getNodeCache(a, b.tId)) {
                ...
                data.removeSelectedNode(a, b);
                for (var f = 0,
                g = e[d].length; g > f; f++) if (e[d][f].tId == b.tId) {
                    e[d].splice(f, 1);
                    break
                }
                ...
                if (a.data.keep.parent || 0 != k) {
                    if (a.view.showLine && k > 0) {
                        var l = e[d][k - 1];
                        if (h = $$(l, consts.id.UL, a), i = $$(l, consts.id.SWITCH, a), j = $$(l, consts.id.ICON, a), e == c) if (1 == e[d].length) view.replaceSwitchClass(l, i, consts.line.ROOT);
                        else {
        ...
        switchNode: function(a, b) {
            if (b.open || !tools.canAsync(a, b)) view.expandCollapseNode(a, b, !b.open);
                ...
                if (!view.asyncNode(a, b)) return void view.expandCollapseNode(a, b, !b.open)
    ...
    $.fn.zTree = {
        ...
        destroy: function(a) {
            ...
            else for (var b in settings) view.destroy(settings[b])
        },
        init: function(a, b, c) {
            ...
            e[f] = d.data.simpleData.enable ? data.transformTozTreeFormat(d, c) : c,
            data.initCache(d),
            event.unbindTree(d),
            event.bindTree(d),
            event.unbindEvent(d),
            ...
            var g = {
                ...
                expandNode: function(a, b, c, e, f) {
                    ...
                    if (data.getRoot(d).expandTriggerFlag = f, !tools.canAsync(d, a) && c) view.expandCollapseSonNode(d, a, b, !0,
                    function() {
                        if (e !== !1) try {
                            $$(a, d).focus().blur()
                        } catch(b) {}
                ...
                getNodeIndex: function(a) {
                    ...
                    c = a.parentTId ? a.getParentNode() : data.getRoot(d), e = 0, f = c[b].length; f > e; e++) if (c[b][e] == a) return e;
                    return - 1
                },
                ...
                reAsyncChildNodes: function(a, b, c) {
                    if (this.setting.async.enable) {
                        ...
                        if (e && (a = data.getRoot(d)), "refresh" == b) {
                            for (var f = this.setting.data.key.children,
                            g = 0,
                            h = a[f] ? a[f].length: 0; h > g; g++) data.removeNodeCache(d, a[f][g]);
                            if (data.removeSelectedNode(d), a[f] = [], e) this.setting.treeObj.empty();
                            else {
                ...
                selectNode: function(a, b) {
                    if (a && tools.uCanDo(d)) {
                        if (b = d.view.selectedMulti && b, a.parentTId) view.expandCollapseParentNode(d, a.getParentNode(), !0, !1,
                        function() {
                            try {
                                $$(a, d).focus().blur()
                            } catch(b) {}
...
function(a) {
    ...
    j = function(a, b, c) {
        a.data.key.checked;
        a.check.enable && (v.makeChkFlag(a, b), c.push("<span ID='", b.tId, t.id.CHECK, "' class='", u.makeChkClass(a, b), "' treeNode", t.id.CHECK, b.nocheck === !0 ? " style='display:none;'": "", "></span>"))
    },
    k = function(a, b) {
        b.checkNode = function(a, b, c, d) {
            var e = this.setting.data.key.checked;
            if (a.chkDisabled !== !0 && (b !== !0 && b !== !1 && (b = !a[e]), d = !!d, (a[e] !== b || c) && (!d || 0 != s.apply(this.setting.callback.beforeCheck, [this.setting.treeId, a], !0)) && s.uCanDo(this.setting) && this.setting.check.enable && a.nocheck !== !0)) {
                a[e] = b;
                var f = w(a, t.id.CHECK, this.setting); (c || this.setting.check.chkStyle === t.radio.STYLE) && u.checkNodeRelation(this.setting, a),
        ...
        b.updateNode = function(a, d) {
            if (c && c.apply(b, arguments), a && this.setting.check.enable) {
                ...
                if (e.get(0) && s.uCanDo(this.setting)) {
                    var f = w(a, t.id.CHECK, this.setting); (1 == d || this.setting.check.chkStyle === t.radio.STYLE) && u.checkNodeRelation(this.setting, a),
                    u.setChkClass(this.setting, f, a),
                    u.repairParentChkClassWithSelf(this.setting, a)
                }
            }
    ...
    l = {
        ...
        getTreeCheckedNodes: function(a, b, c, d) {
            ...
            d = d ? d: [];
            for (var h = 0,
            i = b.length; i > h && (b[h].nocheck === !0 || b[h].chkDisabled === !0 || b[h][f] != c || (d.push(b[h]), !g)) && (v.getTreeCheckedNodes(a, b[h][e], c, d), !(g && d.length > 0)); h++);
            return d
        },
        getTreeChangeCheckedNodes: function(a, b, c) {
            ...
            c = c ? c: [];
            for (var f = 0,
            g = b.length; g > f; f++) b[f].nocheck !== !0 && b[f].chkDisabled !== !0 && b[f][e] != b[f].checkedOld && c.push(b[f]),
    ...
    p = {
        checkNodeRelation: function(a, b) {
            ...
            if (a.check.chkStyle == h.STYLE) {
                ...
                if (b[g]) if (a.check.radioType == h.TYPE_ALL) {
                    for (d = i.length - 1; d >= 0; d--) c = i[d],
                    c[g] && c != b && (c[g] = !1, i.splice(d, 1), u.setChkClass(a, w(c, t.id.CHECK, a), c), c.parentTId != b.parentTId && u.repairParentChkClassWithSelf(a, c));
                    i.push(b)
                } else {
                    var j = b.parentTId ? b.getParentNode() : v.getRoot(a);
                    for (d = 0, e = j[f].length; e > d; d++) c = j[f][d],
                    c[g] && c != b && (c[g] = !1, u.setChkClass(a, w(c, t.id.CHECK, a), c))
                } else if (a.check.radioType == h.TYPE_ALL) for (d = 0, e = i.length; e > d; d++) if (b == i[d]) {
                    i.splice(d, 1);
                    break
                }
            } else b[g] && (!b[f] || 0 == b[f].length || a.check.chkboxType.Y.indexOf("s") > -1) && u.setSonNodeCheckBox(a, b, !0),
        ...
        repairAllChk: function(a, b) {
            if (a.check.enable && a.check.chkStyle === t.checkbox.STYLE) for (var c = a.data.key.checked,
            d = a.data.key.children,
            e = v.getRoot(a), f = 0, g = e[d].length; g > f; f++) {
                var h = e[d][f];
        ...
        repairSonChkDisabled: function(a, b, c, d) {
            if (b) {
                var e = a.data.key.children;
                if (b.chkDisabled != c && (b.chkDisabled = c), u.repairChkClass(a, b), b[e] && d) for (var f = 0,
                g = b[e].length; g > f; f++) {
                    var h = b[e][f];
        ...
        setSonNodeCheckBox: function(a, b, c, d) {
            if (b) {
                ...
                var h = !1;
                if (b[e]) for (var i = 0,
                j = b[e].length; j > i && b.chkDisabled !== !0; i++) {
                    var k = b[e][i];
    ...
    u.removeNode = function(a, b) {
        ...
        b && c && (u.repairChkClass(a, c), u.repairParentChkClass(a, c))
    };
    var z = u.appendNodes;
    u.appendNodes = function(a, b, c, d) {
        var e = "";
        return z && (e = z.apply(u, arguments)),
        d && v.makeChkFlag(a, d),
        e
    }
} (jQuery),
function(a) {
    ...
    j = function(a, b) {
        ...
        b.copyNode = function(a, b, c, d) {
            ...
            var f = this,
            g = r.clone(b);
            return a || (a = null, c = s.move.TYPE_INNER),
            c == s.move.TYPE_INNER ? r.canAsync(this.setting, a) ? t.asyncNode(this.setting, a, d, e) : e() : (t.addNodes(this.setting, a.parentNode, [g], d), t.moveNode(this.setting, a, g, c, !1, d)),
            g
        },
        ...
        b.moveNode = function(a, b, c, d) {
            ...
            if (!b) return b;
            if (a && !a.isParent && this.setting.data.keep.leaf && c === s.move.TYPE_INNER) return null;
            if (a && (b.parentTId == a.tId && c == s.move.TYPE_INNER || v(b, this.setting).find("#" + a.tId).length > 0)) return null;
            a || (a = null);
            var f = this;
    ...
    k = {
        setSonNodeLevel: function(a, b, c) {
            if (c) {
                var d = a.data.key.children;
                if (c.level = b ? b.level + 1 : 0, c[d]) for (var e = 0,
                f = c[d].length; f > e; e++) c[d][e] && u.setSonNodeLevel(a, c, c[d][e])
            }
        }
    },
    l = {},
    m = {
        ...
        onHoverOutNode: function(a) {
            var b = u.getSetting(a.data.treeId),
            c = u.getRoot(b);
        ...
        onMousedownNode: function(c, d) {
            function e(c) {
                ...
                if (A.css("cursor", "pointer"), 0 == k.dragFlag) {
                    if (0 == r.apply(j.callback.beforeDrag, [j.treeId, o], !0)) return f(c),
                    !0;
                    for (d = 0, e = o.length; e > d; d++) 0 == d && (k.dragNodeShowBefore = []),
                    g = o[d],
                    g.isParent && g.open ? (t.expandCollapseNode(j, g, !g.open), k.dragNodeShowBefore[g.tId] = !0) : k.dragNodeShowBefore[g.tId] = !1;
                    k.dragFlag = 1,
                    l.showHoverDom = !1,
                    r.showIfameMask(j, !0);
                    var n = !0,
                    ...
                    for (n && (x = o[0].getPreNode(), y = o[o.length - 1].getNextNode()), p = v("<ul class='zTreeDragUL'></ul>", j), d = 0, e = o.length; e > d; d++) g = o[d],
                    g.editNameFlag = !1,
                    t.selectNode(j, g, d > 0),
                    t.removeTreeDom(j, g),
                    d > j.edit.drag.maxShowNodeNum - 1 || (h = v("<li id='" + g.tId + "_tmp'></li>", j), h.append(v(g, s.id.A, j).clone()), h.css("padding", "0"), h.children("#" + g.tId + s.id.A).removeClass(s.node.CURSELECTED), p.append(h), d == j.edit.drag.maxShowNodeNum - 1 && (h = v("<li id='" + g.tId + "_moretmp'><a>  ...  </a></li>", j), p.append(h)));
                ...
                if (1 == k.dragFlag) {
                    ...
                    ab = U > j.edit.drag.borderMin && V > j.edit.drag.borderMin && W > j.edit.drag.borderMin && X > j.edit.drag.borderMin,
                    bb = Y && C.treeObj.scrollTop() <= 0,
                    cb = Z && C.treeObj.scrollTop() + C.treeObj.height() + 10 >= S,
                    db = $ && C.treeObj.scrollLeft() <= 0,
                    eb = _ && C.treeObj.scrollLeft() + C.treeObj.width() + 10 >= T;
                    if (c.target && r.isChildOrSelf(c.target, C.treeId)) {
                        ...
                        gb && c.target && r.isChildOrSelf(c.target, fb.id + s.id.A) && (w = a(fb), G = fb.id)
                    }
                    g = o[0],
                    ab && r.isChildOrSelf(c.target, C.treeId) && (!w && (c.target.id == C.treeId || bb || cb || db || eb) && (B || !B && g.parentTId) && (w = C.treeObj), Y ? C.treeObj.scrollTop(C.treeObj.scrollTop() - 10) : Z && C.treeObj.scrollTop(C.treeObj.scrollTop() + 10), $ ? C.treeObj.scrollLeft(C.treeObj.scrollLeft() - 10) : _ && C.treeObj.scrollLeft(C.treeObj.scrollLeft() + 10), w && w != C.treeObj && w.offset().left < C.treeObj.offset().left && C.treeObj.scrollLeft(C.treeObj.scrollLeft() + w.offset().left - C.treeObj.offset().left)),
                    p.css({
                    ...
                    if (w && w.attr("id") != C.treeId) {
                        var jb = null == G ? null: u.getNodeCache(C, G),
                        kb = (c.ctrlKey || c.metaKey) && j.edit.drag.isMove && j.edit.drag.isCopy || !j.edit.drag.isMove && j.edit.drag.isCopy,
                        lb = !(!x || G !== x.tId),
                        mb = !(!y || G !== y.tId),
                        nb = g.parentTId && g.parentTId == G,
                        ob = (kb || !mb) && r.apply(C.edit.drag.prev, [C.treeId, o, jb], !!C.edit.drag.prev),
                        pb = (kb || !lb) && r.apply(C.edit.drag.next, [C.treeId, o, jb], !!C.edit.drag.next),
                        qb = !(!kb && nb || C.data.keep.leaf && !jb.isParent || !r.apply(C.edit.drag.inner, [C.treeId, o, jb], !!C.edit.drag.inner));
                        if (ob || pb || qb) {
                            var rb = a("#" + G + s.id.A, w),
                            sb = jb.isLastNode ? null: a("#" + jb.getNextNode().tId + s.id.A, w.next()),
                            tb = rb.offset().top,
                            ub = rb.offset().left,
                            vb = ob ? qb ? .25 : pb ? .5 : 1 : -1,
                            wb = pb ? qb ? .75 : ob ? .5 : 0 : -1,
                            xb = (c.clientY + P - tb) / rb.height();
                            if ((1 == vb || vb >= xb && xb >= -.2) && ob ? (hb = 1 - q.width(), ib = tb - q.height() / 2, H = s.move.TYPE_PREV) : (0 == wb || xb >= wb && 1.2 >= xb) && pb ? (hb = 1 - q.width(), ib = null == sb || jb.isParent && jb.open ? tb + rb.height() - q.height() / 2 : sb.offset().top - q.height() / 2, H = s.move.TYPE_NEXT) : (hb = 5 - q.width(), ib = tb, H = s.move.TYPE_INNER), q.css({
                                display: "block",
                                top: ib + "px",
                                left: ub + hb + "px"
                            }), rb.addClass(s.node.TMPTARGET_NODE + "_" + H), (E != G || F != H) && (K = (new Date).getTime()), jb && jb.isParent && H == s.move.TYPE_INNER) {
                                var yb = !0;
                                window.zTreeMoveTimer && window.zTreeMoveTargetNodeTId !== jb.tId ? (clearTimeout(window.zTreeMoveTimer), window.zTreeMoveTargetNodeTId = null) : window.zTreeMoveTimer && window.zTreeMoveTargetNodeTId === jb.tId && (yb = !1),
                                yb && (window.zTreeMoveTimer = setTimeout(function() {
            ...
            function f(c) {
                function d() {
                    if (B) {
                        if (!n) for (var a = 0,
                        b = o.length; b > a; a++) t.removeNode(j, o[a]);
                        if (H == s.move.TYPE_INNER) t.addNodes(C, x, y);
                        else if (t.addNodes(C, x.getParentNode(), y), H == s.move.TYPE_PREV) for (a = 0, b = y.length; b > a; a++) t.moveNode(C, x, y[a], H, !1);
                        else for (a = -1, b = y.length - 1; b > a; b--) t.moveNode(C, x, y[b], H, !1)
                    } else if (n && H == s.move.TYPE_INNER) t.addNodes(C, x, y);
                    else if (n && t.addNodes(C, x.getParentNode(), y), H != s.move.TYPE_NEXT) for (a = 0, b = y.length; b > a; a++) t.moveNode(C, x, y[a], H, !1);
                    else for (a = -1, b = y.length - 1; b > a; b--) t.moveNode(C, x, y[b], H, !1);
                    t.selectNodes(C, y),
                    v(y[0], j).focus().blur(),
                ...
                if (window.zTreeMoveTimer && (clearTimeout(window.zTreeMoveTimer), window.zTreeMoveTargetNodeTId = null), E = null, F = null, z.unbind("mousemove", e), z.unbind("mouseup", f), z.unbind("selectstart", g), A.css("cursor", "auto"), w && (w.removeClass(s.node.TMPTARGET_TREE), G && a("#" + G + s.id.A, w).removeClass(s.node.TMPTARGET_NODE + "_" + s.move.TYPE_PREV).removeClass(s.node.TMPTARGET_NODE + "_" + b.move.TYPE_NEXT).removeClass(s.node.TMPTARGET_NODE + "_" + b.move.TYPE_INNER)), r.showIfameMask(j, !1), l.showHoverDom = !0, 0 != k.dragFlag) {
                    k.dragFlag = 0;
                    var h, i, m;
                    for (h = 0, i = o.length; i > h; h++) m = o[h],
                    m.isParent && k.dragNodeShowBefore[m.tId] && !m.open && (t.expandCollapseNode(j, m, !m.open), delete k.dragNodeShowBefore[m.tId]);
                    p && p.remove(),
                    q && q.remove();
                    ...
                    if (!n && w && G && o[0].parentTId && G == o[0].parentTId && H == s.move.TYPE_INNER && (w = null), w) {
                        ...
                        if (0 == r.apply(j.callback.beforeDrop, [C.treeId, o, x, H, n], !0)) return void t.selectNodes(D, o);
                        var y = n ? r.clone(o) : o;
                        H == s.move.TYPE_INNER && r.canAsync(C, x) ? t.asyncNode(C, x, !1, d) : d()
                    } else t.selectNodes(D, o),
            ...
            var h, i, j = u.getSetting(c.data.treeId),
            k = u.getRoot(j),
            l = u.getRoots();
            ...
            var p, q, w, x, y, z = a(j.treeObj.get(0).ownerDocument),
            A = a(j.treeObj.get(0).ownerDocument.body),
            B = !1,
            C = j,
            D = j,
            E = null,
    ...
    n = {
        ...
        showIfameMask: function(a, b) {
            for (var c = u.getRoot(a); c.dragMaskList.length > 0;) c.dragMaskList[0].remove(),
    ...
    o = {
        ...
        cancelCurEditNode: function(a, b, c) {
            ...
            if (f) {
                ...
                h = b ? b: c ? f[e] : g.val();
                if (r.apply(a.callback.beforeRename, [a.treeId, f, h, c], !0) === !1) return ! 1;
                f[e] = h,
        ...
        editNode: function(a, b) {
            var c = u.getRoot(a);
            if (t.editNodeBlur = !1, u.isSelectedNode(a, b) && c.curEditNode == b && b.editNameFlag) return void setTimeout(function() {
        ...
        moveNode: function(a, b, c, d, e, f) {
            ...
            if (b != c && (!a.data.keep.leaf || !b || b.isParent || d != s.move.TYPE_INNER)) {
                ...
                d == s.move.TYPE_INNER && (j ? c.parentTId = null: (b.isParent || (b.isParent = !0, b.open = !!b.open, t.setNodeLineIcos(a, b)), c.parentTId = b.tId));
                var l, m;
                if (j) l = a.treeObj,
                m = l;
                else {
                ...
                y = null,
                z = c.level;
                if (c.isFirstNode) r = 0,
                i[h].length > 1 && (x = i[h][1], x.isFirstNode = !0);
                else if (c.isLastNode) r = i[h].length - 1,
                x = i[h][r - 1],
                x.isLastNode = !0;
                else for (p = 0, q = i[h].length; q > p; p++) if (i[h][p].tId == c.tId) {
                    r = p;
                    break
                }
                ...
                a.check && a.check.enable && t.repairChkClass && (t.repairChkClass(a, i), t.repairParentChkClassWithSelf(a, i), i != c.parent && t.repairParentChkClassWithSelf(a, c)),
        ...
        selectNodes: function(a, b) {
            for (var c = 0,
            d = b.length; d > c; c++) t.selectNode(a, b[c], c > 0)
        }
    },
    p = {
        tools: n,
    ...
    r.uCanDo = function(a, b) {
        var c = u.getRoot(a);
        return b && (r.eqs(b.type, "mouseover") || r.eqs(b.type, "mouseout") || r.eqs(b.type, "mousedown") || r.eqs(b.type, "mouseup")) ? !0 : (c.curEditNode && (t.editNodeBlur = !1, c.curEditInput.focus()), !c.curEditNode && (B ? B.apply(t, arguments) : !0))
    }
} (jQuery);