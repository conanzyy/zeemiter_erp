    ...
    $.fn.jqGrid = function(a) {
        ...
        return this.each(function() {
            if (!this.grid) {
                ...
                this.p.colModel[e].nameExt && (this.p.colNames[e] += this.p.colModel[e].nameExt);
                ...
                p = function(a, b, d, e) {
                    var f = '<label><input role="checkbox" type="checkbox" id="jqg_' + c.p.id + "_" + a + '" class="cbox" name="jqg_' + c.p.id + "_" + a + '"' + (e ? 'checked="checked"': "") + "/><span class='text'></span></label>",
                    g = l(b, d, "", null, a, !0);
                ...
                this.p.multiselect && (this.p.colNames.unshift("<label><input role='checkbox' id='cb_" + this.p.id + "' class='cbox' type='checkbox'/><span class='text'></span></label>"), this.p.colModel.unshift({
                    name: "cb",
                ...
                $(c).before(d.hDiv).click(function(a) {
                	if(a.target.tagName != "TD" && a.target.tagName != "INPUT") return;//暂时解决 by shenyang
                ...
                $(d.bDiv).append($('<div style="position:relative;' + (h && $.jgrid.msiever() < 8 ? "height:0.01%;": "") + '"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({
                ...
                if (b) try {
                    if ($(this.p.colModel).each(function(c) {
                        ...
                        i.p.treeGrid === !0 && d === i.p.ExpandColumn) $("td[role='gridcell']:eq(" + c + ") > span:first", h).html(g).attr(e);
                            ...
                            l = j.find("input");
                            l.length ? (g = "&#160;" === g ? "": g, l.val(g).select()) : j.html(g),
                            j.attr(e)
                        }
                    }), "local" === i.p.datatype) {
        ...
        addRowData: function(a, b, c, d) { - 1 == ["first", "last", "before", "after"].indexOf(c) && (c = "last");
            ...
            return b && ($.isArray(b) ? (m = !0, n = a) : (b = [b], m = !1), this.each(function() {
                ...
                z = $.isFunction(u.p.afterInsertRow) ? !0 : !1; v > w;) {
                    ...
                    for (r = a, a = u.p.idPrefix + a, i && (t = u.formatCol(0, 1, "", null, a, !0), f[f.length] = '<td role="gridcell" class="ui-state-default jqgrid-rownum" ' + t + ">0</td>"), g && (l = '<label><input role="checkbox" type="checkbox" id="jqg_' + u.p.id + "_" + a + '" class="cbox"/><span class="text"></span></label>', t = u.formatCol(i, 1, "", null, a, !0), f[f.length] = '<td role="gridcell" ' + t + ">" + l + "</td>"), h && (f[f.length] = $(u).jqGrid("addSubGridCell", g + i, 1)), k = g + h + i; k < u.p.colModel.length; k++) q = u.p.colModel[k],
                    e = q.name,
                    y[e] = p[e],
...
function(a) {
    "use strict";
    a.jgrid.extend({
        editCellByColName: function(b, c, d) {
            return this.each(function() {
                var e, f, g = this;
                if (e = a(g.rows[b + ""]).index(), a(g.rows).each(function() {
                    var c = a(this);
                    c[0].id === b && (e = c.index())
                }), e) if (a.each(g.p.colModel,
                function(a, b) {
                    if (b.name === c) if (b.hidden) {
                        var d = g.p.colModel.length - 1;
                        d = d > a ? a: d - 1,
                        c = g.p.colModel[d + 1].name
                    } else f = a
                }), f) a(g).jqGrid("editCell", e, f, !d);
                else try {
                    console.log("jqGrid-editCellByColName: 找不到对应的colName:" + c + "，可能是之后的列都已经被隐藏")
                } catch(h) {} else try {
                    console.log("jqGrid-editCellByColName: 找不到对应的rowId:" + b)
                } catch(h) {}
            })
        },
        ...
        nextCell: function(b, c) {
            return this.each(function() {
                ...
                f = !1;
                if (e.grid && e.p.cellEdit === !0) {
                    for (d = c + 1; d < e.p.colModel.length; d++) if (e.p.colModel[d].editable === !0 && !e.p.colModel[d].hidden) {
                        f = d;
                        break
                    }
                    if (d === e.p.colModel.length) {
                        ...
                        for (d = 0; d < e.p.colModel.length; d++) if (e.p.colModel[d].editable === !0 && !e.p.colModel[d].hidden) {
                            f = d;
                            break
                        }
                    }
...
function(a) {
    ...
    a.jgrid.extend({
        searchGrid: function(b) {
            ...
            this.each(function() {
                function c(c) {
                    f = a(d).triggerHandler("jqGridFilterBeforeShow", [c]),
                    void 0 === f && (f = !0),
                    f && a.isFunction(b.beforeShowSearch) && (f = b.beforeShowSearch.call(d, c)),
                    f && (a.jgrid.viewModal("#" + a.jgrid.jqID(g.themodal), {
                ...
                if (d.grid) {
                    ...
                    h = d.p.postData[b.sFilter];
                    if ("string" == typeof h && (h = a.jgrid.parse(h)), b.recreateFilter === !0 && a("#" + a.jgrid.jqID(g.themodal)).remove(), void 0 !== a("#" + a.jgrid.jqID(g.themodal))[0]) c(a("#fbox_" + a.jgrid.jqID( + d.p.id)));
                    else {
                        var i = a("<div><div id='" + e + "' class='searchFilter' style='overflow:auto'></div></div>").insertBefore("#gview_" + a.jgrid.jqID(d.p.id)),
                        j = "left",
                        k = "";
                        "rtl" === d.p.direction && (j = "right", k = " style='text-align:left'", i.attr("dir", "rtl"));
                        var l, m, n = a.extend([], d.p.colModel),
                        o = "<a href='javascript:void(0)' id='" + e + "_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'><span class='ui-icon ui-icon-search'></span>" + b.Find + "</a>",
                        p = "<a href='javascript:void(0)' id='" + e + "_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>" + b.Reset + "</a>",
                        q = "",
                        r = "",
                        s = !1,
                        t = -1;
                        if (b.showQuery && (q = "<a href='javascript:void(0)' id='" + e + "_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>"), b.columns.length ? (n = b.columns, t = 0, l = n[0].index || n[0].name) : a.each(n,
                        function(a, b) {
                            if (b.label || (b.label = d.p.colNames[a]), !s) {
                                var c = void 0 === b.search ? !0 : b.search,
                                e = b.hidden === !0,
                                f = b.searchoptions && b.searchoptions.searchhidden === !0; (f && c || c && !e) && (s = !0, l = b.index || b.name, t = a)
                            }
                        }), !h && l || b.multipleSearch === !1) {
                            var u = "eq";
                            t >= 0 && n[t].searchoptions && n[t].searchoptions.sopt ? u = n[t].searchoptions.sopt[0] : b.sopt && b.sopt.length && (u = b.sopt[0]),
                            h = {
                                groupOp: "AND",
                                rules: [{
                                    field: l,
                        ...
                        s = !1,
                        b.tmplNames && b.tmplNames.length && (s = !0, r = b.tmplLabel, r += "<select class='ui-template'>", r += "<option value='default'>Default</option>", a.each(b.tmplNames,
                        function(a, b) {
                            r += "<option value='" + a + "'>" + b + "</option>"
                        }), r += "</select>"),
                        m = "<table class='EditTable' style='border:0px none;margin-top:5px' id='" + e + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:" + j + "'>" + p + r + "</td><td class='EditButton' " + k + ">" + q + o + "</td></tr></tbody></table>",
                        e = a.jgrid.jqID(e),
                        a("#" + e).jqFilter({
                            columns: n,
                            filter: b.loadDefaults ? h: null,
                        ...
                        i.append(m),
                        s && b.tmplFilters && b.tmplFilters.length && a(".ui-template", i).bind("change",
                        function() {
                            var c = a(this).val();
                            return "default" === c ? a("#" + e).jqFilter("addFilter", h) : a("#" + e).jqFilter("addFilter", b.tmplFilters[parseInt(c, 10)]),
                            !1
                        }),
                        ...
                        b.gbox = "#gbox_" + e,
                        b.layer ? a.jgrid.createModal(g, i, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0], "#" + a.jgrid.jqID(b.layer), {
                            position: "relative"
                        }) : a.jgrid.createModal(g, i, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0]),
                        (b.searchOnEnter || b.closeOnEscape) && a("#" + a.jgrid.jqID(g.themodal)).keydown(function(c) {
                            var d = a(c.target);
                            return ! b.searchOnEnter || 13 !== c.which || d.hasClass("add-group") || d.hasClass("add-rule") || d.hasClass("delete-group") || d.hasClass("delete-rule") || d.hasClass("fm-button") && d.is("[id$=_query]") ? b.closeOnEscape && 27 === c.which ? (a("#" + a.jgrid.jqID(g.modalhead)).find(".ui-jqdialog-titlebar-close").focus().click(), !1) : void 0 : (a("#" + e + "_search").focus().click(), !1)
                        }),
                        q && a("#" + e + "_query").bind("click",
                        function() {
                            return a(".queryresult", i).toggle(),
                            !1
                        }),
                        void 0 === b.stringResult && (b.stringResult = b.multipleSearch),
                        a("#" + e + "_search").bind("click",
                        function() {
                            var c, f = a("#" + e),
                            h = {},
                            i = f.jqFilter("filterData");
                            if (b.errorcheck && (f[0].hideError(), b.showQuery || f.jqFilter("toSQLString"), f[0].p.error)) return f[0].showError(),
                            !1;
                            if (b.stringResult) {
                                try {
                                    c = xmlJsonClass.toJson(i, "", "", !1)
                                } catch(j) {
                                    try {
                                        c = JSON.stringify(i)
                                    } catch(k) {}
                                }
                                "string" == typeof c && (h[b.sFilter] = c, a.each([b.sField, b.sValue, b.sOper],
                                function() {
                                    h[this] = ""
                                }))
                            } else b.multipleSearch ? (h[b.sFilter] = i, a.each([b.sField, b.sValue, b.sOper],
                            function() {
                                h[this] = ""
                            })) : (h[b.sField] = i.rules[0].field, h[b.sValue] = i.rules[0].data, h[b.sOper] = i.rules[0].op, h[b.sFilter] = "");
                            return d.p.search = !0,
                            a.extend(d.p.postData, h),
                            a(d).triggerHandler("jqGridFilterSearch"),
                            a.isFunction(b.onSearch) && b.onSearch.call(d),
                            a(d).trigger("reloadGrid", [{
                                page: 1
                            }]),
                            b.closeAfterSearch && a.jgrid.hideModal("#" + a.jgrid.jqID(g.themodal), {
                        ...
                        function() {
                            ...
                            f[0].resetFilter(),
                            s && a(".ui-template", i).val("default"),
                            a.extend(d.p.postData, c),
                            a(d).triggerHandler("jqGridFilterReset"),
                            a.isFunction(b.onReset) && b.onReset.call(d),
                            a(d).trigger("reloadGrid", [{
                                page: 1
                            }]),
                            !1
                        ...
                        c(a("#" + e)),
                        a(".fm-button:not(.ui-state-disabled)", i).hover(function() {
                            a(this).addClass("ui-state-hover")
                        },
                        function() {
                            a(this).removeClass("ui-state-hover")
        ...
        editGridRow: function(c, d) {
            ...
            this.each(function() {
                    ...
                    return a(v + " > tbody > tr > td > .FormElement").each(function() {
                        ...
                        if (b.length) {
                            ...
                            case "select-multiple":
                                ...
                                p[this.name] = p[this.name] ? p[this.name].join(",") : "";
                                var f = [];
                ...
                function f(c, d, e, f) {
                    ...
                    if ("_empty" !== c && (q = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function(m) {
                        if (g = this.name, h = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, k = h ? "style='display:none'": "", "cb" !== g && "subgrid" !== g && this.editable === !0 && "rn" !== g) {
                            ...
                            if ("_empty" === c && u.defaultValue && (j = a.isFunction(u.defaultValue) ? u.defaultValue.call(o) : u.defaultValue), this.edittype || (this.edittype = "text"), o.p.autoencode && (j = a.jgrid.htmlDecode(j)), l = a.jgrid.createEl.call(o, this.edittype, u, j, !1, a.extend({},
                            a.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {})), (b[o.p.id].checkOnSubmit || b[o.p.id].checkOnUpdate) && (b[o.p.id]._savedData[g] = j), a(l).addClass("FormElement"), a.inArray(this.edittype, ["text", "textarea", "password", "select"]) > -1 && a(l).addClass("ui-widget-content ui-corner-all"), i = a(e).find("tr[rowpos=" + w + "]"), v.rowabove) {
                                var y = a("<tr><td class='contentinfo' colspan='" + 2 * f + "'>" + v.rowcontent + "</td></tr>");
                                a(e).append(y),
                                y[0].rp = w
                            }
                            0 === i.length && (i = a("<tr " + k + " rowpos='" + w + "'></tr>").addClass("FormData").attr("id", "tr_" + g), a(i).append(s), a(e).append(i), i[0].rp = w),
                            a("td:eq(" + (x - 2) + ")", i[0]).html(void 0 === v.label ? d.p.colNames[m] : v.label),
                            a("td:eq(" + (x - 1) + ")", i[0]).append(v.elmprefix).append(l).append(v.elmsuffix),
                            a.isFunction(u.custom_value) && "_empty" !== c && u.custom_value.call(o, a("#" + g, "#" + t), "set", j),
                            a.jgrid.bindEv.call(o, l, u),
                            p[n] = m,
                            n++
                        }
                    }), n > 0) {
                        ...
                        u[0].rp = n + 999,
                        a(e).append(u),
                        (b[o.p.id].checkOnSubmit || b[o.p.id].checkOnUpdate) && (b[o.p.id]._savedData[d.p.id + "_id"] = c)
                    }
                    return p
                }
                function g(c, d, e) {
                    var f, g, h, i, j, k, l = 0; (b[o.p.id].checkOnSubmit || b[o.p.id].checkOnUpdate) && (b[o.p.id]._savedData = {},
                    b[o.p.id]._savedData[d.p.id + "_id"] = c);
                    var m = d.p.colModel;
                    if ("_empty" === c) return a(m).each(function() {
                        ...
                        h && h.length && null !== h[0] && (j = "", i.defaultValue ? (j = a.isFunction(i.defaultValue) ? i.defaultValue.call(o) : i.defaultValue, "checkbox" === h[0].type ? (k = j.toLowerCase(), k.search(/(false|f|0|no|n|off|undefined)/i) < 0 && "" !== k ? (h[0].checked = !0, h[0].defaultChecked = !0, h[0].value = j) : (h[0].checked = !1, h[0].defaultChecked = !1)) : h.val(j)) : "checkbox" === h[0].type ? (h[0].checked = !1, h[0].defaultChecked = !1, j = a(h).attr("offval")) : h[0].type && "select" === h[0].type.substr(0, 6) ? h[0].selectedIndex = 0 : h.val(j), (b[o.p.id].checkOnSubmit === !0 || b[o.p.id].checkOnUpdate) && (b[o.p.id]._savedData[f] = j))
                    }),
                    void a("#id_g", "#" + e).val(c);
                        ...
                        if (f = m[h].name, "cb" !== f && "subgrid" !== f && "rn" !== f && m[h].editable === !0) {
                            ...
                            case "checkbox":
                                if (g = String(g), m[h].editoptions && m[h].editoptions.value) {
                                    ...
                                    a("#" + f, "#" + e)[o.p.useProp ? "prop": "attr"](k[0] === g ? {
                                        checked: !0,
                                        defaultChecked: !0
                                    }: {
                                        checked: !1,
                                ...
                                g.search(/(false|f|0|no|n|off|undefined)/i) < 0 && "" !== g ? (a("#" + f, "#" + e)[o.p.useProp ? "prop": "attr"]("checked", !0), a("#" + f, "#" + e)[o.p.useProp ? "prop": "attr"]("defaultChecked", !0)) : (a("#" + f, "#" + e)[o.p.useProp ? "prop": "attr"]("checked", !1), a("#" + f, "#" + e)[o.p.useProp ? "prop": "attr"]("defaultChecked", !1));
                                break;
                            case "custom":
                                try {
                ...
                function i() {
                    ...
                    q && "object" == typeof q && (p = q),
                    a.isFunction(b[o.p.id].beforeCheckValues) && (q = b[o.p.id].beforeCheckValues.call(o, p, a("#" + t), r), q && "object" == typeof q && (p = q));
                    for (i in p) if (p.hasOwnProperty(i) && (l = a.jgrid.checkValues.call(o, p[i], i), l[0] === !1)) break;
                    if (h(), l[0] && (m = a(o).triggerHandler("jqGridAddEditClickSubmit", [b[o.p.id], p, r]), void 0 === m && a.isFunction(b[o.p.id].onclickSubmit) && (m = b[o.p.id].onclickSubmit.call(o, b[o.p.id], p, r) || {}), l = a(o).triggerHandler("jqGridAddEditBeforeSubmit", [p, a("#" + t), r]), void 0 === l && (l = [!0, "", ""]), l[0] && a.isFunction(b[o.p.id].beforeSubmit) && (l = b[o.p.id].beforeSubmit.call(o, p, a("#" + t), r))), l[0] && !b[o.p.id].processing) {
                        if (b[o.p.id].processing = !0, a("#sData", v + "_2").addClass("ui-state-active"), f = n.oper, e = n.id, p[f] = "_empty" === a.trim(p[o.p.id + "_id"]) ? n.addoper: n.editoper, p[f] !== n.addoper ? p[e] = p[o.p.id + "_id"] : void 0 === p[e] && (p[e] = p[o.p.id + "_id"]), delete p[o.p.id + "_id"], p = a.extend(p, b[o.p.id].editData, m), o.p.treeGrid === !0) {
                            ...
                            for (k in o.p.treeReader) if (o.p.treeReader.hasOwnProperty(k)) {
                        ...
                        var y = a.extend({
                            ...
                            complete: function(h, i) {
                                var k;
                                if (p[e] = o.p.idPrefix + p[e], h.status >= 300 && 304 !== h.status ? (l[0] = !1, l[1] = a(o).triggerHandler("jqGridAddEditErrorTextFormat", [h, r]), l[1] = a.isFunction(b[o.p.id].errorTextFormat) ? b[o.p.id].errorTextFormat.call(o, h, r) : i + " Status: '" + h.statusText + "'. Error code: " + h.status) : (l = a(o).triggerHandler("jqGridAddEditAfterSubmit", [h, p, r]), void 0 === l && (l = [!0, "", ""]), l[0] && a.isFunction(b[o.p.id].afterSubmit) && (l = b[o.p.id].afterSubmit.call(o, h, p, r))), l[0] === !1) a("#FormError>td", v).html(l[1]),
                                a("#FormError", v).show();
                                else if (o.p.autoencode && a.each(p,
                                function(b, c) {
                                ...
                                1e3)) : o.p.treeGrid === !0 ? a(o).jqGrid("setTreeRow", p[e], p) : a(o).jqGrid("setRowData", p[e], p), b[o.p.id].closeAfterEdit && a.jgrid.hideModal("#" + a.jgrid.jqID(w.themodal), {
                                    ...
                                    a(o).triggerHandler("jqGridAddEditAfterComplete", [c, p, a("#" + t), r]),
                                    b[o.p.id].afterComplete.call(o, c, p, a("#" + t), r),
                                    c = null
                                },
                                500)), (b[o.p.id].checkOnSubmit || b[o.p.id].checkOnUpdate) && (a("#" + t).data("disabled", !1), "_empty" !== b[o.p.id]._savedData[o.p.id + "_id"])) for (k in b[o.p.id]._savedData) b[o.p.id]._savedData.hasOwnProperty(k) && p[k] && (b[o.p.id]._savedData[k] = p[k]);
                                b[o.p.id].processing = !1,
                                a("#sData", v + "_2").removeClass("ui-state-active");
                                try {
                        ...
                        if (y.url || b[o.p.id].useDataProxy || (a.isFunction(o.p.dataProxy) ? b[o.p.id].useDataProxy = !0 : (l[0] = !1, l[1] += " " + a.jgrid.errors.nourl)), l[0]) if (b[o.p.id].useDataProxy) {
                            var z = o.p.dataProxy.call(o, y, "set_" + o.p.id);
                            void 0 === z && (z = [!0, ""]),
                            z[0] === !1 ? (l[0] = !1, l[1] = z[1] || "Error deleting the selected row!") : (y.data.oper === n.addoper && b[o.p.id].closeAfterAdd && a.jgrid.hideModal("#" + a.jgrid.jqID(w.themodal), {
                                gb: "#gbox_" + a.jgrid.jqID(s),
                                jqm: d.jqModal,
                                onClose: b[o.p.id].onClose
                ...
                function k() {
                    var c = !0;
                    return a("#FormError", v).hide(),
                    b[o.p.id].checkOnUpdate && (p = {},
                    e(), q = j(p, b[o.p.id]._savedData), q && (a("#" + t).data("disabled", !0), a(".confirm", "#" + w.themodal).show(), c = !1)),
                    c
                }
                function l() {
                    var b;
                    if ("_empty" !== c && void 0 !== o.p.savedRow && o.p.savedRow.length > 0 && a.isFunction(a.fn.jqGrid.restoreRow)) for (b = 0; b < o.p.savedRow.length; b++) if (o.p.savedRow[b].id == c) {
                ...
                function m(b, c) {
                    var d = c[1].length - 1;
                    0 === b ? a("#pData", v + "_2").addClass("ui-state-disabled") : void 0 !== c[1][b - 1] && a("#" + a.jgrid.jqID(c[1][b - 1])).hasClass("ui-state-disabled") ? a("#pData", v + "_2").addClass("ui-state-disabled") : a("#pData", v + "_2").removeClass("ui-state-disabled"),
                    b === d ? a("#nData", v + "_2").addClass("ui-state-disabled") : void 0 !== c[1][b + 1] && a("#" + a.jgrid.jqID(c[1][b + 1])).hasClass("ui-state-disabled") ? a("#nData", v + "_2").addClass("ui-state-disabled") : a("#nData", v + "_2").removeClass("ui-state-disabled")
                }
                function n() {
                ...
                if (o.grid && c) {
                    ...
                    D = 0;
                    t = a.jgrid.jqID(t),
                    "new" === c ? (c = "_empty", r = "add", d.caption = b[o.p.id].addCaption) : (d.caption = b[o.p.id].editCaption, r = "edit"),
                    d.recreateForm === !0 && void 0 !== a("#" + a.jgrid.jqID(w.themodal))[0] && a("#" + a.jgrid.jqID(w.themodal)).remove();
                    var E = !0;
                    if (d.checkOnUpdate && d.jqModal && !d.modal && (E = !1), void 0 !== a("#" + a.jgrid.jqID(w.themodal))[0]) {
                        if (B = a(o).triggerHandler("jqGridAddEditBeforeInitData", [a("#" + a.jgrid.jqID(t)), r]), void 0 === B && (B = !0), B && z && (B = z.call(o, a("#" + t), r)), B === !1) return;
                        l(),
                        a(".ui-jqdialog-title", "#" + a.jgrid.jqID(w.modalhead)).html(d.caption),
                        a("#FormError", v).hide(),
                        b[o.p.id].topinfo ? (a(".topinfo", v).html(b[o.p.id].topinfo), a(".tinfo", v).show()) : a(".tinfo", v).hide(),
                        b[o.p.id].bottominfo ? (a(".bottominfo", v + "_2").html(b[o.p.id].bottominfo), a(".binfo", v + "_2").show()) : a(".binfo", v + "_2").hide(),
                        g(c, o, t),
                        "_empty" !== c && b[o.p.id].viewPagerButtons ? a("#pData, #nData", v + "_2").show() : a("#pData, #nData", v + "_2").hide(),
                        b[o.p.id].processing === !0 && (b[o.p.id].processing = !1, a("#sData", v + "_2").removeClass("ui-state-active")),
                        a("#" + t).data("disabled") === !0 && (a(".confirm", "#" + a.jgrid.jqID(w.themodal)).hide(), a("#" + t).data("disabled", !1)),
                        a(o).triggerHandler("jqGridAddEditBeforeShowForm", [a("#" + t), r]),
                        x && x.call(o, a("#" + t), r),
                        a("#" + a.jgrid.jqID(w.themodal)).data("onClose", b[o.p.id].onClose),
                        ...
                        a(o).triggerHandler("jqGridAddEditAfterShowForm", [a("#" + t), r]),
                        y && y.call(o, a("#" + t), r)
                    } else {
                        var F = isNaN(d.dataheight) ? d.dataheight: d.dataheight + "px",
                        G = isNaN(d.datawidth) ? d.datawidth: d.datawidth + "px",
                        ...
                        if (B = a(o).triggerHandler("jqGridAddEditBeforeInitData", [a("#" + t), r]), void 0 === B && (B = !0), B && z && (B = z.call(o, a("#" + t, r))), B === !1) return;
                        l(),
                        ...
                        J[0].rp = 0,
                        a(I).append(J),
                        J = a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='" + 2 * C + "'>" + b[o.p.id].topinfo + "</td></tr>"),
                        J[0].rp = 0,
                        a(I).append(J);
                        ...
                        M = K ? "pData": "nData";
                        f(c, o, I, C);
                        var N = "<a href='javascript:void(0)' id='" + L + "' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",
                        O = "<a href='javascript:void(0)' id='" + M + "' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>",
                        P = "<a href='javascript:void(0)' id='sData' class='fm-button ui-state-default ui-corner-all'>" + d.bSubmit + "</a>",
                        Q = "<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>" + d.bCancel + "</a>",
                        ...
                        if (a.jgrid.createModal(w, U, d, "#gview_" + a.jgrid.jqID(o.p.id), a("#gbox_" + a.jgrid.jqID(o.p.id))[0]), K && (a("#pData, #nData", v + "_2").css("float", "right"), a(".EditButton", v + "_2").css("text-align", "left")), b[o.p.id].topinfo && a(".tinfo", v).show(), b[o.p.id].bottominfo && a(".binfo", v + "_2").show(), U = null, R = null, a("#" + a.jgrid.jqID(w.themodal)).keydown(function(c) {
                            var e = c.target;
                            if (a("#" + t).data("disabled") === !0) return ! 1;
                            if (b[o.p.id].savekey[0] === !0 && c.which === b[o.p.id].savekey[1] && "TEXTAREA" !== e.tagName) return a("#sData", v + "_2").trigger("click"),
                            !1;
                            ...
                            if (b[o.p.id].navkeys[0] === !0) {
                                ...
                                if (c.which === b[o.p.id].navkeys[1]) return a("#pData", v + "_2").trigger("click"),
                                !1;
                                if (c.which === b[o.p.id].navkeys[2]) return a("#nData", v + "_2").trigger("click"),
                                !1
                            }
                            ...
                            P = "<a href='javascript:void(0)' id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" + d.bYes + "</a>",
                            O = "<a href='javascript:void(0)' id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" + d.bNo + "</a>",
                            Q = "<a href='javascript:void(0)' id='cNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" + d.bExit + "</a>";
                            var V = d.zIndex || 999;
                            V++,
                            a("<div class='" + d.overlayClass + " jqgrid-overlay confirm' style='z-index:" + V + ";display:none;'>&#160;</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:" + (V + 1) + "'>" + d.saveData + "<br/><br/>" + P + O + Q + "</div>").insertAfter("#" + t),
                            a("#sNew", "#" + a.jgrid.jqID(w.themodal)).click(function() {
                                return i(),
                                a("#" + t).data("disabled", !1),
                                a(".confirm", "#" + a.jgrid.jqID(w.themodal)).hide(),
                                !1
                            }),
                            a("#nNew", "#" + a.jgrid.jqID(w.themodal)).click(function() {
                                return a(".confirm", "#" + a.jgrid.jqID(w.themodal)).hide(),
                                a("#" + t).data("disabled", !1),
                                setTimeout(function() {
                                    a(":input:visible", "#" + t)[0].focus()
                                },
                        ...
                        a(o).triggerHandler("jqGridAddEditInitializeForm", [a("#" + t), r]),
                        A && A.call(o, a("#" + t), r),
                        "_empty" !== c && b[o.p.id].viewPagerButtons ? a("#pData,#nData", v + "_2").show() : a("#pData,#nData", v + "_2").hide(),
                        a(o).triggerHandler("jqGridAddEditBeforeShowForm", [a("#" + t), r]),
                        x && x.call(o, a("#" + t), r),
                        ...
                        a("#sData", v + "_2").click(function() {
                            ...
                            a("#FormError", v).hide(),
                            e(),
                            "_empty" === p[o.p.id + "_id"] ? i() : d.checkOnSubmit === !0 ? (q = j(p, b[o.p.id]._savedData), q ? (a("#" + t).data("disabled", !0), a(".confirm", "#" + a.jgrid.jqID(w.themodal)).show()) : i()) : i(),
                            !1
                        }),
                        ...
                        a("#nData", v + "_2").click(function() {
                            ...
                            if (b[0] = parseInt(b[0], 10), -1 !== b[0] && b[1][b[0] + 1]) {
                                ...
                                a(o).triggerHandler("jqGridAddEditAfterClickPgButtons", ["next", a("#" + t), b[1][b[0]]]),
                                a.isFunction(d.afterclickPgButtons) && d.afterclickPgButtons.call(o, "next", a("#" + t), b[1][b[0] + 1]),
                                m(b[0] + 1, b)
                            }
                            return ! 1
                        }),
                        a("#pData", v + "_2").click(function() {
                            ...
                            if ( - 1 !== b[0] && b[1][b[0] - 1]) {
                                ...
                                g(b[1][b[0] - 1], o, t),
                                a(o).jqGrid("setSelection", b[1][b[0] - 1]),
                                a(o).triggerHandler("jqGridAddEditAfterClickPgButtons", ["prev", a("#" + t), b[1][b[0]]]),
                                a.isFunction(d.afterclickPgButtons) && d.afterclickPgButtons.call(o, "prev", a("#" + t), b[1][b[0] - 1]),
                                m(b[0] - 1, b)
                            }
                            return ! 1
                        })
        ...
        viewGridRow: function(c, d) {
            ...
            b[a(this)[0].p.id] = d,
            this.each(function() {
                function e() { (b[j.p.id].closeOnEscape === !0 || b[j.p.id].navkeys[0] === !0) && setTimeout(function() {
                ...
                function f(b, c, e, f) {
                    ...
                    if (a(c.p.colModel).each(function() {
                        ...
                        h || "right" !== this.align || (this.formatter && -1 !== a.inArray(this.formatter, v) ? w = Math.max(w, parseInt(this.width, 10)) : x = Math.max(x, parseInt(this.width, 10)))
                        ...
                        if (g = this.name, n = !1, h = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, k = h ? "style='display:none'": "", o = "boolean" != typeof this.viewable ? !0 : this.viewable, "cb" !== g && "subgrid" !== g && "rn" !== g && o) {
                            j = r === !1 ? "": g === c.p.ExpandColumn && c.p.treeGrid === !0 ? a("td:eq(" + b + ")", c.rows[r]).text() : a("td:eq(" + b + ")", c.rows[r]).html(),
                            ...
                            0 === i.length && (i = a("<tr " + k + " rowpos='" + l + "'></tr>").addClass("FormData").attr("id", "trv_" + g), a(i).append(t), a(e).append(i), i[0].rp = l),
                            a("td:eq(" + (s - 2) + ")", i[0]).html("<b>" + (void 0 === d.label ? c.p.colNames[b] : d.label) + "</b>"),
                            a("td:eq(" + (s - 1) + ")", i[0]).append("<span>" + j + "</span>").attr("id", "v_" + g),
                            n && a("td:eq(" + (s - 1) + ") span", i[0]).css({
                                "text-align": "right",
                                width: m + "px"
                            }),
                            q[p] = b,
                ...
                function g(b, c) {
                    ...
                    g && (a("td", g).each(function(b) {
                        ...
                        "cb" !== d && "subgrid" !== d && "rn" !== d && (f = d === c.p.ExpandColumn && c.p.treeGrid === !0 ? a(this).text() : a(this).html(), d = a.jgrid.jqID("v_" + d), a("#" + d + " span", "#" + m).html(f), e && a("#" + d, "#" + m).parents("tr:first").hide(), h++)
                    }), h > 0 && a("#id_g", "#" + m).val(b))
                }
                function h(b, c) {
                    var d = c[1].length - 1;
                ...
                if (j.grid && c) {
                    ...
                    s = 1,
                    t = 0;
                    if (d.recreateForm === !0 && void 0 !== a("#" + a.jgrid.jqID(p.themodal))[0] && a("#" + a.jgrid.jqID(p.themodal)).remove(), void 0 !== a("#" + a.jgrid.jqID(p.themodal))[0]) {
                        if (q && (r = q.call(j, a("#" + l)), void 0 === r && (r = !0)), r === !1) return;
                        a(".ui-jqdialog-title", "#" + a.jgrid.jqID(p.modalhead)).html(d.caption),
                        a("#FormError", "#" + m).hide(),
                        g(c, j),
                        a.isFunction(b[j.p.id].beforeShowForm) && b[j.p.id].beforeShowForm.call(j, a("#" + l)),
                        ...
                        z = y ? "nData": "pData",
                        A = y ? "pData": "nData",
                        B = "<a href='javascript:void(0)' id='" + z + "' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",
                        C = "<a href='javascript:void(0)' id='" + A + "' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>",
                        D = "<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>" + d.bClose + "</a>";
                        if (t > 0) {
                            var E = [];
                            a.each(a(x)[0].rows,
                            function(a, b) {
                        ...
                        a.jgrid.createModal(p, F, d, "#gview_" + a.jgrid.jqID(j.p.id), a("#gview_" + a.jgrid.jqID(j.p.id))[0]),
                        y && (a("#pData, #nData", "#" + m + "_2").css("float", "right"), a(".EditButton", "#" + m + "_2").css("text-align", "left")),
                        d.viewPagerButtons || a("#pData, #nData", "#" + m + "_2").hide(),
                        F = null,
                        a("#" + p.themodal).keydown(function(c) {
                            ...
                            !1;
                            if (d.navkeys[0] === !0) {
                                if (c.which === d.navkeys[1]) return a("#pData", "#" + m + "_2").trigger("click"),
                                !1;
                                if (c.which === d.navkeys[2]) return a("#nData", "#" + m + "_2").trigger("click"),
                                !1
                            }
                        }),
                        d.closeicon = a.extend([!0, "left", "ui-icon-close"], d.closeicon),
                        d.closeicon[0] === !0 && a("#cData", "#" + m + "_2").addClass("right" === d.closeicon[1] ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='ui-icon " + d.closeicon[2] + "'></span>"),
                        a.isFunction(d.beforeShowForm) && d.beforeShowForm.call(j, a("#" + l)),
                        a.jgrid.viewModal("#" + a.jgrid.jqID(p.themodal), {
                            gbox: "#gbox_" + a.jgrid.jqID(k),
                            jqm: d.jqModal,
                            overlay: d.overlay,
                        ...
                        a("#nData", "#" + m + "_2").click(function() {
                            ...
                            -1 !== b[0] && b[1][b[0] + 1] && (a.isFunction(d.onclickPgButtons) && d.onclickPgButtons.call(j, "next", a("#" + l), b[1][b[0]]), g(b[1][b[0] + 1], j), a(j).jqGrid("setSelection", b[1][b[0] + 1]), a.isFunction(d.afterclickPgButtons) && d.afterclickPgButtons.call(j, "next", a("#" + l), b[1][b[0] + 1]), h(b[0] + 1, b)),
                            e(),
                            !1
                        }),
                        a("#pData", "#" + m + "_2").click(function() {
                            a("#FormError", "#" + m).hide();
                            var b = i();
                            return - 1 !== b[0] && b[1][b[0] - 1] && (a.isFunction(d.onclickPgButtons) && d.onclickPgButtons.call(j, "prev", a("#" + l), b[1][b[0]]), g(b[1][b[0] - 1], j), a(j).jqGrid("setSelection", b[1][b[0] - 1]), a.isFunction(d.afterclickPgButtons) && d.afterclickPgButtons.call(j, "prev", a("#" + l), b[1][b[0] - 1]), h(b[0] - 1, b)),
                            e(),
                            !1
                        })
                    }
            ...
            this.each(function() {
                ...
                if (e.grid && c) {
                    ...
                    if (a.isArray(c) && (c = c.join()), void 0 !== a("#" + a.jgrid.jqID(r.themodal))[0]) {
                        ...
                        a("#DelData>td", "#" + p).text(c),
                        a("#DelError", "#" + p).hide(),
                        b[e.p.id].processing === !0 && (b[e.p.id].processing = !1, a("#dData", "#" + p).removeClass("ui-state-active")),
                        j && b[e.p.id].beforeShowForm.call(e, a("#" + p)),
                        ...
                        u += "<tr id='DelError' style='display:none'><td class='ui-state-error'></td></tr>",
                        u += "<tr id='DelData' style='display:none'><td >" + c + "</td></tr>",
                        u += '<tr><td class="delmsg" style="white-space:pre;">' + b[e.p.id].msg + "</td></tr><tr><td >&#160;</td></tr>",
                        u += "</tbody></table></div>";
                        var v = "<a href='javascript:void(0)' id='dData' class='fm-button ui-state-default ui-corner-all'>" + d.bSubmit + "</a>",
                        w = "<a href='javascript:void(0)' id='eData' class='fm-button ui-state-default ui-corner-all'>" + d.bCancel + "</a>";
                        ...
                        d.delicon[0] === !0 && a("#dData", "#" + p + "_2").addClass("right" === d.delicon[1] ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='ui-icon " + d.delicon[2] + "'></span>"),
                        d.cancelicon[0] === !0 && a("#eData", "#" + p + "_2").addClass("right" === d.cancelicon[1] ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='ui-icon " + d.cancelicon[2] + "'></span>"),
                        a("#dData", "#" + p + "_2").click(function() {
                            var c, j = [!0, ""],
                            k = a("#DelData>td", "#" + p).text();
                            if (n = {},
                            a.isFunction(b[e.p.id].onclickSubmit) && (n = b[e.p.id].onclickSubmit.call(e, b[e.p.id], k) || {}), a.isFunction(b[e.p.id].beforeSubmit) && (j = b[e.p.id].beforeSubmit.call(e, k)), j[0] && !b[e.p.id].processing) {
                                if (b[e.p.id].processing = !0, h = e.p.prmNames, f = a.extend({},
                                b[e.p.id].delData, n), i = h.oper, f[i] = h.deloper, g = h.id, k = String(k).split(","), !k.length) return ! 1;
                                ...
                                var l = a.extend({
                                    ...
                                    complete: function(c, g) {
                                        var h;
                                        if (c.status >= 300 && 304 !== c.status ? (j[0] = !1, j[1] = a.isFunction(b[e.p.id].errorTextFormat) ? b[e.p.id].errorTextFormat.call(e, c) : g + " Status: '" + c.statusText + "'. Error code: " + c.status) : a.isFunction(b[e.p.id].afterSubmit) && (j = b[e.p.id].afterSubmit.call(e, c, f)), j[0] === !1) a("#DelError>td", "#" + p).html(j[1]),
                                        a("#DelError", "#" + p).show();
                                        else {
                                            if (b[e.p.id].reloadAfterSubmit && "local" !== e.p.datatype) a(e).trigger("reloadGrid");
                                                ...
                                                } catch(i) {} else for (h = 0; h < k.length; h++) a(e).jqGrid("delRowData", e.p.idPrefix + k[h]);
                                                e.p.selrow = null,
                                                e.p.selarrrow = []
                                            }
                                        ...
                                        a("#dData", "#" + p + "_2").removeClass("ui-state-active"),
                                        j[0] && a.jgrid.hideModal("#" + a.jgrid.jqID(r.themodal), {
                                ...
                                if (l.url || b[e.p.id].useDataProxy || (a.isFunction(e.p.dataProxy) ? b[e.p.id].useDataProxy = !0 : (j[0] = !1, j[1] += " " + a.jgrid.errors.nourl)), j[0]) if (b[e.p.id].useDataProxy) {
                                    var o = e.p.dataProxy.call(e, l, "del_" + e.p.id);
                                    void 0 === o && (o = [!0, ""]),
                                    o[0] === !1 ? (j[0] = !1, j[1] = o[1] || "Error deleting the selected row!") : a.jgrid.hideModal("#" + a.jgrid.jqID(r.themodal), {
                                        gb: "#gbox_" + a.jgrid.jqID(m),
                                        jqm: d.jqModal,
                                        onClose: b[e.p.id].onClose
                                    })
                            ...
                            return j[0] === !1 && (a("#DelError>td", "#" + p).html(j[1]), a("#DelError", "#" + p).show()),
                            !1
                        }),
                ...
                if (!this.nav) {
                    ...
                    if (l.grid && "string" == typeof b) {
                        ...
                        for (c.cloneToTop && l.p.toppager && (n = 2), m = 0; n > m; m++) {
                            ...
                            0 === m ? (r = b, s = l.p.id, r === l.p.toppager && (s += "_top", n = 1)) : (r = l.p.toppager, s = l.p.id + "_top"),
                            "rtl" === l.p.direction && a(t).attr("dir", "rtl").css("float", "right"),
                            c.add && (e = e || {},
                            q = a("<td class='ui-pg-button ui-corner-all'></td>"), a(q).append("<div class='ui-pg-div'><span class='ui-icon " + c.addicon + "'></span>" + c.addtext + "</div>"), a("tr", t).append(q), a(q, t).attr({
                                title: c.addtitle || "",
                                id: e.id || "add_" + s
                            }).click(function() {
                                return a(this).hasClass("ui-state-disabled") || (a.isFunction(c.addfunc) ? c.addfunc.call(l) : a(l).jqGrid("editGridRow", "new", e)),
                                !1
                            }).hover(o, p), q = null),
                            c.edit && (q = a("<td class='ui-pg-button ui-corner-all'></td>"), d = d || {},
                            a(q).append("<div class='ui-pg-div'><span class='ui-icon " + c.editicon + "'></span>" + c.edittext + "</div>"), a("tr", t).append(q), a(q, t).attr({
                                title: c.edittitle || "",
                                id: d.id || "edit_" + s
                            }).click(function() {
                            ...
                            c.view && (q = a("<td class='ui-pg-button ui-corner-all'></td>"), h = h || {},
                            a(q).append("<div class='ui-pg-div'><span class='ui-icon " + c.viewicon + "'></span>" + c.viewtext + "</div>"), a("tr", t).append(q), a(q, t).attr({
                                title: c.viewtitle || "",
                                id: h.id || "view_" + s
                            }).click(function() {
                                if (!a(this).hasClass("ui-state-disabled")) {
                            ...
                            c.del && (q = a("<td class='ui-pg-button ui-corner-all'></td>"), f = f || {},
                            a(q).append("<div class='ui-pg-div'><span class='ui-icon " + c.delicon + "'></span>" + c.deltext + "</div>"), a("tr", t).append(q), a(q, t).attr({
                                title: c.deltitle || "",
                                id: f.id || "del_" + s
                            }).click(function() {
                                if (!a(this).hasClass("ui-state-disabled")) {
                                    var b;
                                    l.p.multiselect ? (b = l.p.selarrrow, 0 === b.length && (b = null)) : b = l.p.selrow,
                                    b ? a.isFunction(c.delfunc) ? c.delfunc.call(l, b) : a(l).jqGrid("delGridRow", b, f) : (a.jgrid.viewModal("#" + k.themodal, {
                                        gbox: "#gbox_" + a.jgrid.jqID(l.p.id),
                                        jqm: !0
                                    }), a("#jqg_alrt").focus())
                                }
                            ...
                            (c.add || c.edit || c.del || c.view) && a("tr", t).append(u),
                            c.search && (q = a("<td class='ui-pg-button ui-corner-all'></td>"), g = g || {},
                            a(q).append("<div class='ui-pg-div'><span class='ui-icon " + c.searchicon + "'></span>" + c.searchtext + "</div>"), a("tr", t).append(q), a(q, t).attr({
                                title: c.searchtitle || "",
                                id: g.id || "search_" + s
                            }).click(function() {
                                return a(this).hasClass("ui-state-disabled") || (a.isFunction(c.searchfunc) ? c.searchfunc.call(l, g) : a(l).jqGrid("searchGrid", g)),
                                !1
                            }).hover(o, p), g.showOnLoad && g.showOnLoad === !0 && a(q, t).click(), q = null),
                            c.refresh && (q = a("<td class='ui-pg-button ui-corner-all'></td>"), a(q).append("<div class='ui-pg-div'><span class='ui-icon " + c.refreshicon + "'></span>" + c.refreshtext + "</div>"), a("tr", t).append(q), a(q, t).attr({
                                title: c.refreshtitle || "",
                                id: "refresh_" + s
                            }).click(function() {
                                if (!a(this).hasClass("ui-state-disabled")) {
                                    a.isFunction(c.beforeRefresh) && c.beforeRefresh.call(l),
                                    l.p.search = !1;
                                    try {
                                        var b = l.p.id;
                            ...
                            i = a(t).clone().appendTo("#testpg2").width(),
                            a("#testpg2").remove(),
                            a(r + "_" + c.position, r).append(t),
                            l.p._nvtd && (i > l.p._nvtd[0] && (a(r + "_" + c.position, r).width(i), l.p._nvtd[0] = i), l.p._nvtd[1] = i),
                            j = null,
                            i = null,
                            t = null,
                            this.nav = !0
            ...
            this.each(function() {
                if (this.grid) {
                    ...
                    if (d) {
                        ...
                        var f = a("<td></td>");
                        a(f).addClass("ui-pg-button ui-corner-all").append("NONE" === c.buttonicon.toString().toUpperCase() ? "<div class='ui-pg-div'>" + c.caption + "</div>": "<div class='ui-pg-div'><span class='ui-icon " + c.buttonicon + "'></span>" + c.caption + "</div>"),
                        c.id && a(f).attr("id", c.id),
                        "first" === c.position ? 0 === d.rows[0].cells.length ? a("tr", d).append(f) : a("tr td:eq(0)", d).before(f) : a("tr", d).append(f),
                        a(f, d).attr("title", c.title || "").click(function(b) {
                            return a(this).hasClass("ui-state-disabled") || a.isFunction(c.onClickButton) && c.onClickButton.call(e, b),
                            !1
                        }).hover(function() {
                            a(this).hasClass("ui-state-disabled") || a(this).addClass("ui-state-hover")
                        },
