  ...
  <div class="search-wrap" id="report-search">
    <div class="s-inner cf">
          ...
          <div class="con">
            ...
            <ul class="filter-list" id="more-conditions">
			  ...
			  <li class="chk-list dn" id="profit-wrap">
                <label class="chk">
                  <input type="checkbox" value="profit" name="profit" /> 计算毛利</label>
              </li>
            </ul>
            <div class="btns"> 
            	<a href="#" id="conditions-trigger" class="conditions-trigger" tabindex ="-1">更多条件<b></b></a> 
            	<a class="ui-btn ui-btn-sp" id="filter-submit" href="#">确定</a> <a class="ui-btn" id="filter-reset" href="#" tabindex="-1">重置</a> 
            </div>
          </div>
        </div>
      ...
      <div class="fr">
      	...
      	<a href="#" class="ui-btn fl" id="btn-export">导出</a>
      </div>
    </div>
  </div>
