...
<title>在线进销存</title>
<link href="<?php echo base_url()?>statics/css/common.css?ver=20160830" rel="stylesheet">
<link href="<?php echo base_url()?>statics/css/<?php echo sys_skin()?>/ui.min.css?ver=20160830" rel="stylesheet">
<script src="<?php echo base_url()?>statics/js/common/seajs/2.1.1/sea.js?ver=20160830" id="seajsnode"></script>
...
#goodsAuto{width:150px;}
#storageAuto{width:150px;}
...
<div class="mod-report">
  <div class="search-wrap">
    <div class="s-inner cf">
        ...
        <div class="fr"><!-- <a href="#" class="ui-btn ui-btn-sp mrb fl" id="btn-print">打印</a> --><a href="#" class="ui-btn ui-btn-sp fl" id="btn-export">导出</a></div>
    </div>
