...
<table width="1440px" class="list">
  			<tr><td class='H' align="center" colspan="<?php echo 6 + count($storage)?>"><h3>商品库存余额表<h3></td></tr>
  			<tr><td colspan="<?php echo 6 + count($storage)?>">日期：<?php echo $beginDate;?>至<?php echo $endDate;?></td></tr>
</table>
