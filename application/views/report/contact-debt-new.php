    ...
    <div class="s-inner cf">
        <div class="fl">
          <ul class="ul-inline">
            ...
            <li>
            	<label for="customer"><input type="checkbox" id="customer"/><span class = 'text f14' style = "margin-top:5px;">&nbsp;&nbsp;客户</span></label>
            </li>
            <li>
            	<label for="supplier"><input type="checkbox" id="supplier"/><span class = 'text f14' style = "margin-top:5px;">&nbsp;&nbsp;供应商</span></label>
            </li>
