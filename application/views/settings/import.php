...
(function($){
	...
	var uploadInstance = new SWFUpload({
				upload_url: "../basedata/invlocation/saveGoods?jsessionid=AA76C16AF22059B6D59198658E425278",
    ...
    function uploadSuccess(file, serverData) {
        try {
            ...
            if (serverData === "") {
                ...
                if(data.file){
                    var html = "<br/><a href='../../index.php/basedata/invlocation/downError?action=download&filename=" + data.file + "' class='link'>下载错误数据文件</a>";
                    $('#import-result').append(html);
                }
                //更新期间数据
