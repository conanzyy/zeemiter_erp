...
#tree{background-color: #fff;width: 231px;border: solid #ddd 1px;margin-left: 5px;height:100%;}
...
#hideTree{cursor: pointer;color:#fff;height:20px;width:40px;text-align:center;background-color: #B9B9B9;border-radius: 3px;position: absolute;top: 5px;right: 5px;}
...
<div class="container fix p10">
	  <div class="mod-search m0 cf">
	    ...
	    <div class = 'fr'>
            <a class="ui-btn" id = "btn-goods-price">售价导入</a>
	    	<a class="ui-btn" id = "btn-goods-import">期初导入</a>&nbsp;
			<a class="ui-btn ui-btn-sp display_select2">按车型查找 ></a>
			<a class="ui-btn key_select hide">按关键字查找 ></a>
		</div>
	  </div>
	  <div class="cf">
    ...
    <div class="mod-bottom" id="cart_main">
        <div class="membercenter-box-bd" style = "min-height:36px;">
            <div class="row brand-border" id = "letter-search">
                <a class="ui-btn ui-btn-sp mrb fl " id="return"  style=" margin-top:3px;">&lt;&nbsp;返回</a>
...
<script src="<?php echo base_url()?>statics/js/dist/goodsListKz.js?ver=20160800"></script>
<script type="text/javascript">
$(function(){
	...
	$('.display_select').on('click',function(){
		    ...
		    SEARCH_URL = "../basedata/inventory/carSearch?query=true";
	...
	$('.key_select').on('click',function(){
		    ...
		    SEARCH_URL = "../basedata/inventory?action=kzlist&query=true";
	})
