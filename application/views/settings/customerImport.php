    ...
    <div class="mod-inner"  style="width:480px; ">
        ...
        <div id="import-wrap" class="cf">
            <div id="import-step1" class="step-item">
                ...
                <p><a href="../import/downloadtemplate5" class="link">下载导入客户模版</a></p>
                <div class="step-btns">
            ...
            <div id="import-step2" class="step-item" style="display:none;">
                <div class="ctn">
                    <span class="tit">请选择导入的客户类别：</span>
                    <select id="category">
            ...
            <div id="import-step3" class="step-item" style="display:none;">
                ...
                <div class="step-btns">
                    <a href="#" class="ui-btn mrb" id="a_step3">上一步</a><a href="#" class="ui-btn ui-btn-sp" id="btn-complete">完成</a>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    (function($){
        ...
        var defaultPage = Public.getDefaultPage();
        var storageCombo = $("#storage").combo({
            data: function() {
        ...
        var uploadInstance = new SWFUpload({
            upload_url: "../../basedata/invlocation/saveCustomer?action=saveImport&jsessionid=AA76C16AF22059B6D59198658E425278",
        ...
        function findImportResult() {
            $.ajax({
                url: '../basedata/invlocation/saveImport?action=saveImport',
                type: 'post',
                dataType: 'json',
        ...
        $('#btn-import').on('click',function(e){
            ...
            if(!$('#category option:selected').val()){
                parent.Public.tips({content: '客户类别不能为空! ',type : 2});
                return;
            }
            uploadInstance.setPostParams({'categoryId' : $('#category option:selected').val() ,'categoryName' : $('#category option:selected').text()  });
            uploadInstance.startUpload();
        });
        ...
        function uploadStart(){
            progressPop = $.dialog.tips('正在导入，请耐心等待...',1000,'',true).show();
        }
        ...
        function uploadSuccess(file, serverData) {
            try {
                ...
                if (serverData === "") {
                    ...
                    if(data.file){
                        var html = "<br/><a href='../../basedata/invlocation/downError?action=download&filename=" + data.file + "' class='link'>下载错误数据文件</a>";
                        $('#import-result').append(html);
                    }
                    //更新期间数据
                    Public.getDefaultPage().getStorage();
