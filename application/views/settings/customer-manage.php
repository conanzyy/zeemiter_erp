    	...
    	<form id="manage-form" action="">
    		<ul class="mod-form-rows base-form" id="base-form">
    			<li class="row-item odd">
    				<div class="label-wrap"><label for="number">客户编号 <em style = "color:red">*</em></label></div>
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="number" readonly="readonly" id="number"></div>
					<input type="hidden" value="<?php echo $number ?>" id="preNum"/>
    			</li>
    			<li class="row-item">
    				<div class="label-wrap"><label for="name">客户名称 <em style = "color:red">*</em></label></div>
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="name" id="name"></div>
    			</li>
    			<li class="row-item odd row-category">
    				<div class="label-wrap"><label for="category">客户类别 <em style = "color:red">*</em></label></div>
    				<div class="ctn-wrap"><span id="category"></span></div>
    			</li>
    			<!-- <li class="row-item" style >
