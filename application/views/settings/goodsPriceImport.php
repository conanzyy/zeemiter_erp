	...
	<div class="mod-inner"  style="width:480px; ">
      ...
      <div id="import-wrap" class="cf">
          <div id="import-step1" class="step-item">
              ...
              <p><a href="../import/downloadtemplate4" class="link">下载导入商品售价模版</a></p>
              <div class="step-btns">
          ...
          <div id="import-step2" class="step-item" style="display:none;">
              <div class="ctn"> 
                  <span class="tit">请选择导入的价格类别：</span>
                  <select id="category">
...
(function($){	
	...
	var uploadInstance = new SWFUpload({
				upload_url: "../../basedata/invlocation/saveGoodsPrice?action=saveImport&jsessionid=AA76C16AF22059B6D59198658E425278",
	...
	$('#btn-import').on('click',function(e){
		...
		uploadInstance.setPostParams({'categoryId' : $('#category option:selected').val() });
		uploadInstance.startUpload();
	});
