	...
	<div class="mod-inner"  style="width:480px; ">
      ...
      <div id="import-wrap" class="cf">
          <div id="import-step1" class="step-item">
              ...
              <p><a href="../import/downloadtemplate?t=goodsInitImport" class="link">下载导入商品期初模版</a></p>
              <div class="step-btns">
...
(function($){	
	...
	var uploadInstance = new SWFUpload({
				upload_url: "../../basedata/invlocation/saveImportGoodsInit?action=saveImport&jsessionid=AA76C16AF22059B6D59198658E425278",
	...
	$('#btn-import').on('click',function(e){
		...
		uploadInstance.setPostParams({'voucherReSeq' : ($('#voucherReSeq').attr('checked') ? 1 : 0) ,'storageId' : storageCombo.getValue()});
		uploadInstance.startUpload();
	});
