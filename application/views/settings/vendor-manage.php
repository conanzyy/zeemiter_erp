...
<div class="manage-wrapper">
    <div id="manage-wrap" class="manage-wrap">
    	<form id="manage-form" action=""><?php echo $isSelf ?>
    		<ul class="mod-form-rows base-form cf" id="base-form">
    			<li class="row-item odd self">
    				<div class="label-wrap"><label for="number">供应商编号 <em style="color:red">*</em></label></div>
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="number" id="number"></div>
					<input type="hidden" value="<?php echo $number ?>" id="preNum" />
    			</li>
    			<li class="row-item self">
    				<div class="label-wrap"><label for="name">供应商名称 <em style="color:red">*</em></label></div>
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="name" id="name"></div>
    			</li>
    			<li class="row-item odd row-category self">
    				<div class="label-wrap"><label for="category">供应商类别 <em style="color:red">*</em></label></div>
    		...
    		<ul class="mod-form-rows remark self">
    			<li class="row-item">
...
<script src="<?php echo base_url()?>/statics/js/dist/vendorManage.js?ver=20140430"></script>
</body>
</html>
