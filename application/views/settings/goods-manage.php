...
.manage-wrapper{margin:0 auto;width:870px;padding: 15px;}
        ...
        <div id="manage-wrap" class="manage-wrap">
            <form id="manage-form" action="">
                <ul class="mod-form-rows base-form cf" id="base-form">
                    <li class="row-item">
                        <div class="label-wrap"><label for="number">商品编号 <em style="color:red">*</em></label></div>
                        <div class="ctn-wrap"><input type="text" value="" class="ui-input" name="number" id="number"></div>
                    </li>
                    <li class="row-item">
                        <div class="label-wrap"><label for="name">商品名称 <em style="color:red">*</em></label></div>
                    ...
                    <li class="row-item">
                        <div class="label-wrap"><label for="category">商品类别 <em style="color:red">*</em></label></div>
                        <div class="ctn-wrap"><span id="category"></span></div>
                    </li>
                    <li class="row-item">
                        <div class="label-wrap"><label for="storage">首选仓库<em style="color:red">*</em></label></div>
                        <div class="ctn-wrap"><span id="storage"></span></div>
                    </li>
                    <li class="row-item">
                        <div class="label-wrap"><label for="minInventory">最低库存<em style="color:red">*</em></label></div>
                        <div class="ctn-wrap"><input type="text" class="ui-input" name="minInventory" id="minInventory"></div>
                    </li>
                    <li class="row-item">
                        <div class="label-wrap"><label for="maxInventory">最高库存<em style="color:red">*</em></label></div>
                        <div class="ctn-wrap"><input type="text" class="ui-input" name="maxInventory" id="maxInventory"></div>
                    </li>  
                    <li class="row-item row-category">
                        <div class="label-wrap"><label for="unit">计量单位 <em style="color:red">*</em></label></div>
