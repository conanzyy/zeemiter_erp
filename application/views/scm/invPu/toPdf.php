...
<?php for($t=1; $t<=$countpage; $t++){?>
		...
		<table width="900" align="center">
			<tr height="15" align="left" >
				<td width="360" style="font-family:'宋体'; font-size:14px;height:20px;">供应商：<?php echo $contactNo.' '.$contactName?> </td>
				<td width="10" ></td>
		...
		<table width="900" border="1" cellpadding="2" cellspacing="1" align="center" style="border-collapse:collapse;border:solid #000000;border-width:1px 0 0 1px;">
				<tr style="height:20px">
					...
					<td width="260" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;" align="center">商品</td> 
					...
					<td width="60" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;" align="center">仓库</td>
					<td width="60" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;" align="center">货位</td>
				</tr>
			   ...
			   ?>
				<tr style="height:20px ;font-family:'宋体'; font-size:13px;" >
				   <td width="30"  style="border:solid #000000;border-width:0 1px 1px 0;height:30px;font-family:'宋体'; font-size:12px;" align="center"><?php echo $row['i']?></td>
					<td width="240" ><?php echo $row['goods'];?></td>
					<td width="30" align="center"><?php echo $row['unitName']?></td>
					<td width="40" align="right"><?php echo str_money(abs($row['qty']),$system['qtyPlaces'])?></td>
					<td width="60" align="right"><?php echo str_money(abs($row['price']))?></td>
					...
					<td width="60"><?php echo $row['locationArea']?></td>
				</tr>
				<?php 
				    $s = $row['i'];
				    }
