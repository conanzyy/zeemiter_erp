...
<table width="1500px" class="list">
  			<tr><td class='H' align="center" colspan="22"><h3><?php if($transType == '150501') echo '采购记录'; else if($transType == '150502') echo '采购退货记录'  ?></h3></td></tr>
  		</table>
		<table width="1500px" class="list"  border="1">
			<thead>
				<tr>
					...
					<!-- <th width="60" align="center">区域</th>	 -->
