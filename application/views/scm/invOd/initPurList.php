...
#matchCon{width:240px;box-shadow: 1px 1px 1px #f0f0f0 inset;
    border-radius: 3px;
}
...
<div class="wrapper">
  <div class="mod-toolbar-top cf">
      <div class="left">
          ...
          <div id="assisting-category-select" class="ui-tab-select">
            ...
            <ul class="searchbox cf">
	            <li>
	              <input type="text" id="matchCon" class="ui-input ui-input-ph matchCon" value="单据编号/商品编码/厂商产品码">
	            </li>
      ...
      <div class="fr">
        ...
        <a class="ui-btn" id="btn-refresh">刷新</a></div>
    </div>
    <div class="grid-wrap">
      <table id="grid">
      </table>
...
<script src="<?php echo base_url()?>statics/js/dist/purchaseOrdersList.js?ver=20121021"></script>
