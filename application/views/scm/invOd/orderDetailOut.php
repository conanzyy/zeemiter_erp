	    ...
	    <div class="left">
          ...
          <div id="assisting-category-select" class="ui-tab-select">
          	<ul class="searchbox cf">
	            <li>
	              <input type="text" id="matchCon" class="ui-input ui-input-ph matchCon" placeholder="单据编号" >
	            </li>
		         <li>
		          <label>日期:</label>
...
<script src="<?php echo base_url()?>statics/js/dist/orderDetailOut.js?ver=20150522"></script>
