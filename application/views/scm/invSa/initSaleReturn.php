	    ...
	    <div class="left">
          ...
          <div id="assisting-category-select" class="ui-tab-select">
            ...
            <ul class="searchbox cf">
		        <li>
		          <input type="text" id="matchCon" class="ui-input ui-input-ph matchCon" value="输入退换货编号查询">
		        </li>
...
<script src="<?php echo base_url()?>statics/js/dist/saleReturn.js"></script>
</body>
</html>
