...
<?php for($t=1; $t<=$countpage; $t++){?>
		<table  width="800"  align="center">
		    ...
		    <tr height="15px">
				<td align="center" style="font-family:'宋体'; font-size:18px; font-weight:normal;">快准车服<?php echo $system['companyName']?></td>
			</tr> 
			<tr height="15px">
				<td align="center" style="font-family:'宋体'; font-size:18px; font-weight:normal;height:25px;">手工订单</td>
			</tr>
		</table>	
		...
		<table width="900" border="1" cellpadding="2" cellspacing="1" align="center" style="border-collapse:collapse;border:solid #000000;border-width:1px 0 0 1px;">   
			<tr style="height:20px">
					...
					<td width="100" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;" align="center">单位</td>
			   ...
			   ?>
				<tr style="border:solid #000000;border-width:0 1px 1px 0;padding:2px;height:15px;font-family:'宋体'; font-size:12px;">
				   <td width="30"  align="center"><?php echo $row['i']?></td>
					<td width="280" style="border:solid #000000;border-width:0 1px 1px 0;height:15px;font-family:'宋体'; font-size:12px;"><?php echo $row['goods'];?></td>
		...
		<table  width="800" align="center">
			<tr height="15" align="left">
				...
				<td width="150">送货员：___________</td>
				<td width="300">支付方式：现金<input type="radio" >&nbsp;支付宝<input type="radio" >&nbsp;微信<input type="radio" >&nbsp;银行转账<input type="radio" ></td>
			</tr>
			<tr height="15" align="left">
