            ...
            <div id="assisting-category-select" class="ui-tab-select">
               ...
               <span id="custom-assisting"></span>
                ...
                <ul class="searchbox cf">
                    <li>
                        <input type="text" id="matchCon" class="ui-input ui-input-ph matchCon" value="输入订单编号查询">
                    </li>
                    <li><a class="ui-btn mrb" id="search">查询</a></li>
                </ul>
            </div>
        </div>
        <div class="fr"><a class="ui-btn" id
...
<script src="<?php echo base_url()?>statics/js/dist/shopSaleList.js?ver=20140430"></script>
</body>
</html>
