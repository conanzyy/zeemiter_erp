...
<body>
<div class="wrapper">
  <span id="config" class="ui-icon ui-state-default ui-icon-config hide"></span>
  ...
  <div class="bills cf">
    <div class="con-header">
      <dl class="cf">
        ...
        <dd id="identifier" class="mr20 tc">
          <label>销售人员：</label>
        ...
        <dd id="identifier" class="mr20 tc">
          <label>单据编号：</label>
          <span id="number"><?php echo str_no('XS');?></span>
        </dd>
      ...
      <hr class = "hrcls"/>
      <div class="cf  button-row" id = "button-row">
		  <div class="fl">
    ...
    <div class="con-footer cf">
      ...
      <ul id="amountArea" class="cf">
        ...
        <li id="paymentWrap">
          <label>付款方式:</label>
          <span class="ui-combo-wrap" id="payments" style="padding:0;">
          <input type="text" class="input-txt" autocomplete="off">
          <i class="trigger"></i></span><a id="paymentInfo" class="ui-icon ui-icon-folder-open" style="display:none;"></a>
        </li>
        <li id="accountWrap" >
          <label>结算账户:</label>
    ...
    <form action="../scm/invSa/toPdfs" target="_blank" method="post" id="form" style="display: none;">
  ...
  <input type="text" class="textbox sourceOrder" name="sourceOrder" id = "sourceOrder" autocomplete="off" style="display: none;">
