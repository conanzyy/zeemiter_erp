...
<?php for($t=1; $t<=$countpage; $t++){?>
		...
		<table width="800" border="1" cellpadding="2" cellspacing="1" align="center" style="border-collapse:collapse;border:solid #000000;border-width:1px 0 0 1px;">   
			<tr style="height:20px">
					...
					<td width="100" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;" align="center">商品</td> 
					...
					<td width="90" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;" align="center">调出仓库</td>
                                        <td width="90" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;" align="center">调出仓库区域</td>
					<td width="90" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;" align="center">调入仓库</td>
                                        <td width="90" style="border:solid #000000;border-width:0 1px 1px 0;padding:2px; font-family:'宋体'; font-size:14px;height:15px;" align="center">调入仓库区域</td>
			   ...
			   ?>
				<tr style="border:solid #000000;border-width:0 1px 1px 0;padding:2px;height:12px;font-family:'宋体'; font-size:12px;">
				   <td  align="center"><?php echo $row['i']?></td>
					<td width="100" ><?php echo $row['goods'];?></td>
					...
					<td width="90" align="left"><?php echo $row['outLocationName']?></td>
					<td width="90" align="left"><?php echo $row['outinAreaName']?></td>
                                        <td width="90" align="left"><?php echo $row['inLocationName']?></td>
					<td width="90" align="left"><?php echo $row['inAreaName']?></td>
				</tr>
				<?php 
				    }
				    $i++;
				...
				?>
				 ...
				 <tr style="border:solid #000000;border-width:0 1px 1px 0;padding:2px;height:15px;font-family:'宋体'; font-size:12px;">
				   <td colspan="3" width="240" align="right">合计：</td>
