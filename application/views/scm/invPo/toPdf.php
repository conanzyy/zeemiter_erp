...
<head>
<title><?php echo $transType==150501 ? '采购订单' :'采购退货订单'?></title>
...
<?php for($t=1; $t<=$countpage; $t++){?>
		<table  width="800"  align="center">
			...
			<tr height="15px">
				<td align="center" style="font-family:'宋体'; font-size:18px; font-weight:normal;height:25px;"><?php echo $transType==150501 ? '采购订单' :'采购退货订单'?></td>
			</tr>
		</table>	
