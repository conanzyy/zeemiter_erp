...
<head>
	<title>设置独立密码</title>
	<meta charset="utf-8" />
	<link rel="stylesheet" href="<?php echo base_url()?>statics/css/phone_validate.css" />
	<script src="<?php echo base_url()?>statics/js/common/libs/password/jquery.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url()?>statics/js/common/libs/password/checkPassword.js"></script>
	<script src="<?php echo base_url()?>statics/js/common/libs/password/phone_validate.js"></script>
<style>
	body{font: 12px/1.5 "Microsoft YaHei",tahoma,arial,"Hiragino Sans GB","\5b8b\4f53",sans-serif; color:#555;}
