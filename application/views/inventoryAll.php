  ...
  <div class="mod-search m0 cf" style="padding-right:0;">
    <div class="fl">
      <ul class="ul-inline">
        ...
        <li>
          <input type="text" id="matchCon" class="ui-input" placeholder="输入商品编号、名称 、型号">
        </li>
...
<script src="<?php echo base_url()?>statics/js/dist/goodsInventoryAll.js?ver=20140430"></script>
</body>
</html>